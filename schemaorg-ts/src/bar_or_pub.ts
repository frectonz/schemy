 ...
 **/
export type BarOrPubAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type BarOrPubAdditionalTypeFieldEnum = string;
...
export interface BarOrPub {
   ...
   **/
  menu: all.OneOrMany<all.BarOrPubMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.BarOrPubHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.BarOrPubAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.BarOrPubUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.BarOrPubSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.BarOrPubPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.BarOrPubKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.BarOrPubOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.BarOrPubServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.BarOrPubKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.BarOrPubLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.BarOrPubDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.BarOrPubLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.BarOrPubOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.BarOrPubBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.BarOrPubKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.BarOrPubFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.BarOrPubAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.BarOrPubCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.BarOrPubSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.BarOrPubMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.BarOrPubDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.BarOrPubEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.BarOrPubActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.BarOrPubAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.BarOrPubMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.BarOrPubMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.BarOrPubAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.BarOrPubFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.BarOrPubMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.BarOrPubIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.BarOrPubDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.BarOrPubSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.BarOrPubAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.BarOrPubImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.BarOrPubPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.BarOrPubGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.BarOrPubGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.BarOrPubGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.BarOrPubGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.BarOrPubGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.BarOrPubGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.BarOrPubLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.BarOrPubHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.BarOrPubGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.BarOrPubGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.BarOrPubLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.BarOrPubGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.BarOrPubGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.BarOrPubPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.BarOrPubGeoEqualsFieldEnum>;
}
