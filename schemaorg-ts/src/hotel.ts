 ...
 **/
export type HotelPetsAllowedFieldEnum = string;

/**
 * <https://schema.org/checkoutTime>
 **/
export type HotelCheckoutTimeFieldEnum = string;

/**
 * <https://schema.org/checkinTime>
 **/
export type HotelCheckinTimeFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type HotelAdditionalTypeFieldEnum = string;
...
export interface Hotel {
   ...
   * <https://schema.org/petsAllowed>
   **/
  petsAllowed: all.OneOrMany<all.HotelPetsAllowedFieldEnum>;

  /**
   * <https://schema.org/availableLanguage>
   **/
  availableLanguage: all.OneOrMany<all.HotelAvailableLanguageFieldEnum>;

  /**
   * <https://schema.org/checkoutTime>
   **/
  checkoutTime: all.OneOrMany<all.HotelCheckoutTimeFieldEnum>;

  /**
   * <https://schema.org/checkinTime>
   **/
  checkinTime: all.OneOrMany<all.HotelCheckinTimeFieldEnum>;

  /**
   * <https://schema.org/numberOfRooms>
   **/
  numberOfRooms: all.OneOrMany<all.HotelNumberOfRoomsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.HotelUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.HotelSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.HotelPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.HotelKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.HotelOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.HotelServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.HotelKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.HotelLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.HotelDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.HotelLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.HotelOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.HotelBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.HotelKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.HotelFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.HotelAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.HotelCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.HotelSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.HotelMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.HotelDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.HotelEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.HotelActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.HotelAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.HotelMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.HotelMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.HotelAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.HotelFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.HotelMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.HotelIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.HotelDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.HotelSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.HotelAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.HotelImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.HotelPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.HotelGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.HotelGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.HotelGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.HotelGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.HotelGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.HotelGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.HotelLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.HotelHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.HotelGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.HotelGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.HotelLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.HotelGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.HotelGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.HotelPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.HotelGeoEqualsFieldEnum>;
}
