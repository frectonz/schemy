 ...
 **/
export type PalliativeProcedureAdditionalTypeFieldEnum = string;
...
export interface PalliativeProcedure {
   ...
   **/
  preparation: all.OneOrMany<all.PalliativeProcedurePreparationFieldEnum>;

  /**
   * <https://schema.org/status>
   **/
  status: all.OneOrMany<all.PalliativeProcedureStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.PalliativeProcedureLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PalliativeProcedureMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PalliativeProcedureIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PalliativeProcedureDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PalliativeProcedureSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PalliativeProcedureAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PalliativeProcedureImageFieldEnum>;

  /**
   * <https://schema.org/contraindication>
   **/
  contraindication: all.OneOrMany<all.PalliativeProcedureContraindicationFieldEnum>;
