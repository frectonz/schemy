 ...
 **/
export type DistilleryAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type DistilleryAdditionalTypeFieldEnum = string;
...
export interface Distillery {
   ...
   **/
  menu: all.OneOrMany<all.DistilleryMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.DistilleryHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.DistilleryAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.DistilleryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.DistillerySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.DistilleryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.DistilleryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.DistilleryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.DistilleryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.DistilleryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.DistilleryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.DistilleryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.DistilleryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.DistilleryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.DistilleryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.DistilleryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.DistilleryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.DistilleryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.DistilleryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.DistillerySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.DistilleryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.DistilleryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.DistilleryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.DistilleryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.DistilleryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.DistilleryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.DistilleryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.DistilleryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.DistilleryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.DistilleryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.DistilleryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.DistilleryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.DistillerySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.DistilleryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.DistilleryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.DistilleryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.DistilleryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.DistilleryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.DistilleryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.DistilleryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.DistilleryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.DistilleryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.DistilleryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.DistilleryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.DistilleryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.DistilleryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.DistilleryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.DistilleryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.DistilleryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.DistilleryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.DistilleryGeoEqualsFieldEnum>;
}
