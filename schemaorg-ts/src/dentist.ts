 ...
 **/
export type DentistAdditionalTypeFieldEnum = string;
...
export interface Dentist {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.DentistUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.DentistSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.DentistPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.DentistKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.DentistOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.DentistServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.DentistKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.DentistLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.DentistDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.DentistLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.DentistOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.DentistBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.DentistKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.DentistFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.DentistAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.DentistCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.DentistSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.DentistMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.DentistDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.DentistEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.DentistActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.DentistAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.DentistMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.DentistMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.DentistAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.DentistFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.DentistMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.DentistIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.DentistDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.DentistSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.DentistAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.DentistImageFieldEnum>;
   ...
   **/
  photos: all.OneOrMany<all.DentistPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.DentistGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.DentistGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.DentistGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.DentistGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.DentistGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.DentistGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.DentistLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.DentistHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.DentistGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.DentistGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.DentistLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.DentistGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.DentistGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.DentistPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.DentistGeoEqualsFieldEnum>;
}
