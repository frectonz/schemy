 ...
 **/
export type AnatomicalSystemAdditionalTypeFieldEnum = string;
...
export interface AnatomicalSystem {
   ...
   **/
  comprisedOf: all.OneOrMany<all.AnatomicalSystemComprisedOfFieldEnum>;

  /**
   * <https://schema.org/relatedStructure>
   **/
  relatedStructure: all.OneOrMany<all.AnatomicalStructure>;

  /**
   * <https://schema.org/legalStatus>
   **/
  legalStatus: all.OneOrMany<all.AnatomicalSystemLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AnatomicalSystemMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AnatomicalSystemIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AnatomicalSystemDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AnatomicalSystemSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AnatomicalSystemAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AnatomicalSystemImageFieldEnum>;
}
