 ...
 **/
export type LocksmithAdditionalTypeFieldEnum = string;
...
export interface Locksmith {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.LocksmithUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.LocksmithSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.LocksmithPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.LocksmithKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.LocksmithOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.LocksmithServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.LocksmithKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.LocksmithLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.LocksmithDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.LocksmithLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.LocksmithOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.LocksmithBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.LocksmithKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.LocksmithFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.LocksmithAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.LocksmithCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.LocksmithSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.LocksmithMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.LocksmithDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.LocksmithEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.LocksmithActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.LocksmithAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.LocksmithMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.LocksmithMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.LocksmithAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.LocksmithFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.LocksmithMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.LocksmithIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.LocksmithDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.LocksmithSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.LocksmithAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.LocksmithImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.LocksmithPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.LocksmithGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.LocksmithGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.LocksmithGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.LocksmithGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.LocksmithGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.LocksmithGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.LocksmithLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.LocksmithHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.LocksmithGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.LocksmithGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.LocksmithLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.LocksmithGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.LocksmithGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.LocksmithPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.LocksmithGeoEqualsFieldEnum>;
}
