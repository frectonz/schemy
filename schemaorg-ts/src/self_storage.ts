 ...
 **/
export type SelfStorageAdditionalTypeFieldEnum = string;

/**
 * <https://schema.org/SelfStorage>
 **/
export interface SelfStorage {
  "@context": string;
  "@type": "SelfStorage";
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.SelfStorageUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.SelfStorageSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.SelfStoragePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.SelfStorageKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.SelfStorageOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.SelfStorageServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.SelfStorageKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.SelfStorageLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.SelfStorageDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.SelfStorageLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.SelfStorageOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.SelfStorageBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.SelfStorageKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.SelfStorageFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.SelfStorageAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.SelfStorageCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.SelfStorageSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.SelfStorageMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.SelfStorageDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.SelfStorageEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.SelfStorageActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.SelfStorageAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.SelfStorageMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.SelfStorageMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.SelfStorageAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.SelfStorageFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.SelfStorageMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.SelfStorageIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.SelfStorageDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.SelfStorageSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.SelfStorageAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.SelfStorageImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.SelfStoragePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.SelfStorageGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.SelfStorageGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.SelfStorageGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.SelfStorageGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.SelfStorageGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.SelfStorageGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.SelfStorageLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.SelfStorageHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.SelfStorageGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.SelfStorageGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.SelfStorageLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.SelfStorageGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.SelfStorageGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.SelfStoragePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.SelfStorageGeoEqualsFieldEnum>;
}
