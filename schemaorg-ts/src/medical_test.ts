 ...
 **/
export type MedicalTestAdditionalTypeFieldEnum = string;
...
export interface MedicalTest {
   ...
   **/
  normalRange: all.OneOrMany<all.MedicalTestNormalRangeFieldEnum>;

  /**
   * <https://schema.org/legalStatus>
   **/
  legalStatus: all.OneOrMany<all.MedicalTestLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MedicalTestMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MedicalTestIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MedicalTestDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MedicalTestSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MedicalTestAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MedicalTestImageFieldEnum>;
}
