 ...
 **/
export type PathologyTestAdditionalTypeFieldEnum = string;
...
export interface PathologyTest {
   ...
   **/
  tissueSample: all.OneOrMany<string>;
   ...
   **/
  normalRange: all.OneOrMany<all.PathologyTestNormalRangeFieldEnum>;

  /**
   * <https://schema.org/legalStatus>
   **/
  legalStatus: all.OneOrMany<all.PathologyTestLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PathologyTestMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PathologyTestIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PathologyTestDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PathologyTestSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PathologyTestAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PathologyTestImageFieldEnum>;
}
