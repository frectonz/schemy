 ...
 **/
export type AutoDealerAdditionalTypeFieldEnum = string;
...
export interface AutoDealer {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.AutoDealerUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.AutoDealerSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.AutoDealerPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.AutoDealerKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.AutoDealerOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.AutoDealerServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.AutoDealerKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.AutoDealerLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.AutoDealerDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.AutoDealerLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.AutoDealerOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.AutoDealerBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.AutoDealerKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.AutoDealerFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.AutoDealerAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.AutoDealerCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.AutoDealerSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.AutoDealerMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.AutoDealerDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.AutoDealerEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.AutoDealerActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.AutoDealerAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.AutoDealerMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.AutoDealerMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.AutoDealerAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.AutoDealerFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AutoDealerMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AutoDealerIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AutoDealerDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AutoDealerSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AutoDealerAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AutoDealerImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.AutoDealerPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.AutoDealerGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.AutoDealerGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.AutoDealerGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.AutoDealerGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.AutoDealerGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.AutoDealerGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.AutoDealerLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.AutoDealerHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.AutoDealerGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.AutoDealerGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.AutoDealerLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.AutoDealerGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.AutoDealerGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.AutoDealerPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.AutoDealerGeoEqualsFieldEnum>;
}
