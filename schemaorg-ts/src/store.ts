 ...
 **/
export type StoreAdditionalTypeFieldEnum = string;
...
export interface Store {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.StoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.StoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.StorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.StoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.StoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.StoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.StoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.StoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.StoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.StoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.StoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.StoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.StoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.StoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.StoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.StoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.StoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.StoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.StoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.StoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.StoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.StoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.StoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.StoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.StoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.StoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.StoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.StoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.StoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.StoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.StoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.StoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.StorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.StoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.StoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.StoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.StoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.StoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.StoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.StoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.StoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.StoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.StoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.StoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.StoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.StoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.StorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.StoreGeoEqualsFieldEnum>;
}
