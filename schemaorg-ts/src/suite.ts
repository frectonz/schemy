 ...
 **/
export type SuitePetsAllowedFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type SuiteAdditionalTypeFieldEnum = string;
...
export interface Suite {
   ...
   **/
  bed: all.OneOrMany<all.SuiteBedFieldEnum>;

  /**
   * <https://schema.org/numberOfRooms>
   **/
  numberOfRooms: all.OneOrMany<all.SuiteNumberOfRoomsFieldEnum>;
   ...
   * <https://schema.org/petsAllowed>
   **/
  petsAllowed: all.OneOrMany<all.SuitePetsAllowedFieldEnum>;
   ...
   **/
  numberOfBedrooms: all.OneOrMany<all.SuiteNumberOfBedroomsFieldEnum>;
   ...
   **/
  leaseLength: all.OneOrMany<all.SuiteLeaseLengthFieldEnum>;
   ...
   **/
  photos: all.OneOrMany<all.SuitePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.SuiteGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.SuiteGeoOverlapsFieldEnum>;
   ...
   **/
  geoCrosses: all.OneOrMany<all.SuiteGeoCrossesFieldEnum>;

  /**
   * <https://schema.org/keywords>
   **/
  keywords: all.OneOrMany<all.SuiteKeywordsFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.SuiteGeoCoveredByFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.SuiteLogoFieldEnum>;

  /**
   * <https://schema.org/geoContains>
   **/
  geoContains: all.OneOrMany<all.SuiteGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.SuiteGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.SuiteLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.SuiteHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.SuiteGeoTouchesFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.SuiteAddressFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.SuiteGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.SuiteLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.SuiteGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.SuiteGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.SuitePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.SuiteGeoEqualsFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.SuiteMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.SuiteIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.SuiteDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.SuiteSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.SuiteAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.SuiteImageFieldEnum>;
}
