 ...
 **/
export type SchoolAdditionalTypeFieldEnum = string;
...
export interface School {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.SchoolUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.SchoolSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.SchoolPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.SchoolKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.SchoolOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.SchoolServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.SchoolKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.SchoolLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.SchoolDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.SchoolLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.SchoolOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.SchoolBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.SchoolKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.SchoolFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.SchoolAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.SchoolCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.SchoolSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.SchoolMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.SchoolDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.SchoolEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.SchoolActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.SchoolAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.SchoolMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.SchoolMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.SchoolAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.SchoolFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.SchoolMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.SchoolIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.SchoolDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.SchoolSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.SchoolAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.SchoolImageFieldEnum>;
   ...
   **/
  photos: all.OneOrMany<all.SchoolPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.SchoolGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.SchoolGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.SchoolGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.SchoolGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.SchoolGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.SchoolGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.SchoolLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.SchoolHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.SchoolGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.SchoolGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.SchoolLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.SchoolGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.SchoolGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.SchoolPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.SchoolGeoEqualsFieldEnum>;
}
