 ...
 **/
export type HVACBusinessAdditionalTypeFieldEnum = string;
...
export interface HVACBusiness {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.HVACBusinessUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.HVACBusinessSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.HVACBusinessPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.HVACBusinessKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.HVACBusinessOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.HVACBusinessServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.HVACBusinessKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.HVACBusinessLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.HVACBusinessDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.HVACBusinessLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.HVACBusinessOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.HVACBusinessBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.HVACBusinessKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.HVACBusinessFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.HVACBusinessAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.HVACBusinessCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.HVACBusinessSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.HVACBusinessMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.HVACBusinessDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.HVACBusinessEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.HVACBusinessActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.HVACBusinessAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.HVACBusinessMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.HVACBusinessMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.HVACBusinessAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.HVACBusinessFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.HVACBusinessMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.HVACBusinessIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.HVACBusinessDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.HVACBusinessSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.HVACBusinessAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.HVACBusinessImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.HVACBusinessPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.HVACBusinessGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.HVACBusinessGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.HVACBusinessGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.HVACBusinessGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.HVACBusinessGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.HVACBusinessGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.HVACBusinessLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.HVACBusinessHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.HVACBusinessGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.HVACBusinessGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.HVACBusinessLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.HVACBusinessGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.HVACBusinessGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.HVACBusinessPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.HVACBusinessGeoEqualsFieldEnum>;
}
