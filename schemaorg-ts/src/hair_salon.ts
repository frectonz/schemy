 ...
 **/
export type HairSalonAdditionalTypeFieldEnum = string;
...
export interface HairSalon {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.HairSalonUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.HairSalonSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.HairSalonPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.HairSalonKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.HairSalonOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.HairSalonServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.HairSalonKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.HairSalonLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.HairSalonDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.HairSalonLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.HairSalonOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.HairSalonBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.HairSalonKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.HairSalonFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.HairSalonAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.HairSalonCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.HairSalonSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.HairSalonMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.HairSalonDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.HairSalonEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.HairSalonActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.HairSalonAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.HairSalonMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.HairSalonMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.HairSalonAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.HairSalonFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.HairSalonMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.HairSalonIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.HairSalonDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.HairSalonSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.HairSalonAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.HairSalonImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.HairSalonPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.HairSalonGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.HairSalonGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.HairSalonGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.HairSalonGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.HairSalonGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.HairSalonGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.HairSalonLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.HairSalonHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.HairSalonGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.HairSalonGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.HairSalonLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.HairSalonGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.HairSalonGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.HairSalonPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.HairSalonGeoEqualsFieldEnum>;
}
