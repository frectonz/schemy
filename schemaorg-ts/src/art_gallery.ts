 ...
 **/
export type ArtGalleryAdditionalTypeFieldEnum = string;
...
export interface ArtGallery {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.ArtGalleryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.ArtGallerySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.ArtGalleryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.ArtGalleryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.ArtGalleryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.ArtGalleryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.ArtGalleryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.ArtGalleryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.ArtGalleryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.ArtGalleryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.ArtGalleryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.ArtGalleryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.ArtGalleryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.ArtGalleryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.ArtGalleryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.ArtGalleryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.ArtGallerySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.ArtGalleryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.ArtGalleryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.ArtGalleryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.ArtGalleryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.ArtGalleryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.ArtGalleryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.ArtGalleryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.ArtGalleryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.ArtGalleryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.ArtGalleryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.ArtGalleryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.ArtGalleryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.ArtGallerySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.ArtGalleryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.ArtGalleryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.ArtGalleryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.ArtGalleryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.ArtGalleryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.ArtGalleryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.ArtGalleryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.ArtGalleryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.ArtGalleryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.ArtGalleryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.ArtGalleryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.ArtGalleryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.ArtGalleryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.ArtGalleryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.ArtGalleryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.ArtGalleryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.ArtGalleryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.ArtGalleryGeoEqualsFieldEnum>;
}
