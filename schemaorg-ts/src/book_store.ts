 ...
 **/
export type BookStoreAdditionalTypeFieldEnum = string;
...
export interface BookStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.BookStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.BookStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.BookStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.BookStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.BookStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.BookStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.BookStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.BookStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.BookStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.BookStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.BookStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.BookStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.BookStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.BookStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.BookStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.BookStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.BookStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.BookStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.BookStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.BookStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.BookStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.BookStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.BookStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.BookStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.BookStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.BookStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.BookStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.BookStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.BookStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.BookStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.BookStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.BookStoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.BookStorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.BookStoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.BookStoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.BookStoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.BookStoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.BookStoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.BookStoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.BookStoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.BookStoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.BookStoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.BookStoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.BookStoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.BookStoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.BookStoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.BookStorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.BookStoreGeoEqualsFieldEnum>;
}
