 ...
 **/
export type MedicalGuidelineAdditionalTypeFieldEnum = string;
...
export interface MedicalGuideline {
   ...
   **/
  legalStatus: all.OneOrMany<all.MedicalGuidelineLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MedicalGuidelineMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MedicalGuidelineIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MedicalGuidelineDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MedicalGuidelineSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MedicalGuidelineAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MedicalGuidelineImageFieldEnum>;
}
