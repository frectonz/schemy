 ...
 **/
export type WineryAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type WineryAdditionalTypeFieldEnum = string;
...
export interface Winery {
   ...
   **/
  menu: all.OneOrMany<all.WineryMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.WineryHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.WineryAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.WineryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.WinerySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.WineryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.WineryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.WineryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.WineryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.WineryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.WineryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.WineryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.WineryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.WineryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.WineryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.WineryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.WineryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.WineryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.WineryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.WinerySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.WineryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.WineryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.WineryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.WineryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.WineryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.WineryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.WineryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.WineryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.WineryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.WineryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.WineryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.WineryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.WinerySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.WineryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.WineryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.WineryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.WineryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.WineryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.WineryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.WineryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.WineryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.WineryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.WineryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.WineryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.WineryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.WineryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.WineryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.WineryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.WineryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.WineryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.WineryGeoEqualsFieldEnum>;
}
