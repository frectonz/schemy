 ...
 **/
export type BakeryAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type BakeryAdditionalTypeFieldEnum = string;
...
export interface Bakery {
   ...
   **/
  menu: all.OneOrMany<all.BakeryMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.BakeryHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.BakeryAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.BakeryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.BakerySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.BakeryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.BakeryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.BakeryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.BakeryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.BakeryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.BakeryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.BakeryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.BakeryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.BakeryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.BakeryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.BakeryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.BakeryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.BakeryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.BakeryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.BakerySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.BakeryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.BakeryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.BakeryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.BakeryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.BakeryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.BakeryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.BakeryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.BakeryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.BakeryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.BakeryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.BakeryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.BakeryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.BakerySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.BakeryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.BakeryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.BakeryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.BakeryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.BakeryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.BakeryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.BakeryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.BakeryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.BakeryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.BakeryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.BakeryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.BakeryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.BakeryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.BakeryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.BakeryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.BakeryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.BakeryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.BakeryGeoEqualsFieldEnum>;
}
