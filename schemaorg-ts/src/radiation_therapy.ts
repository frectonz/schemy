 ...
 **/
export type RadiationTherapyAdditionalTypeFieldEnum = string;
...
export interface RadiationTherapy {
   ...
   **/
  contraindication: all.OneOrMany<all.RadiationTherapyContraindicationFieldEnum>;
   ...
   **/
  preparation: all.OneOrMany<all.RadiationTherapyPreparationFieldEnum>;

  /**
   * <https://schema.org/status>
   **/
  status: all.OneOrMany<all.RadiationTherapyStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.RadiationTherapyLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.RadiationTherapyMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.RadiationTherapyIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.RadiationTherapyDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.RadiationTherapySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.RadiationTherapyAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.RadiationTherapyImageFieldEnum>;
}
