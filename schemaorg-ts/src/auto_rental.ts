 ...
 **/
export type AutoRentalAdditionalTypeFieldEnum = string;
...
export interface AutoRental {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.AutoRentalUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.AutoRentalSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.AutoRentalPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.AutoRentalKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.AutoRentalOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.AutoRentalServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.AutoRentalKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.AutoRentalLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.AutoRentalDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.AutoRentalLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.AutoRentalOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.AutoRentalBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.AutoRentalKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.AutoRentalFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.AutoRentalAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.AutoRentalCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.AutoRentalSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.AutoRentalMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.AutoRentalDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.AutoRentalEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.AutoRentalActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.AutoRentalAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.AutoRentalMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.AutoRentalMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.AutoRentalAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.AutoRentalFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AutoRentalMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AutoRentalIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AutoRentalDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AutoRentalSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AutoRentalAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AutoRentalImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.AutoRentalPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.AutoRentalGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.AutoRentalGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.AutoRentalGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.AutoRentalGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.AutoRentalGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.AutoRentalGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.AutoRentalLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.AutoRentalHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.AutoRentalGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.AutoRentalGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.AutoRentalLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.AutoRentalGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.AutoRentalGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.AutoRentalPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.AutoRentalGeoEqualsFieldEnum>;
}
