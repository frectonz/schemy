 ...
 **/
export type DaySpaAdditionalTypeFieldEnum = string;
...
export interface DaySpa {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.DaySpaUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.DaySpaSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.DaySpaPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.DaySpaKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.DaySpaOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.DaySpaServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.DaySpaKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.DaySpaLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.DaySpaDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.DaySpaLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.DaySpaOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.DaySpaBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.DaySpaKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.DaySpaFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.DaySpaAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.DaySpaCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.DaySpaSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.DaySpaMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.DaySpaDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.DaySpaEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.DaySpaActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.DaySpaAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.DaySpaMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.DaySpaMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.DaySpaAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.DaySpaFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.DaySpaMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.DaySpaIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.DaySpaDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.DaySpaSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.DaySpaAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.DaySpaImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.DaySpaPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.DaySpaGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.DaySpaGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.DaySpaGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.DaySpaGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.DaySpaGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.DaySpaGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.DaySpaLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.DaySpaHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.DaySpaGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.DaySpaGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.DaySpaLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.DaySpaGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.DaySpaGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.DaySpaPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.DaySpaGeoEqualsFieldEnum>;
}
