 ...
 **/
export type BreweryAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type BreweryAdditionalTypeFieldEnum = string;
...
export interface Brewery {
   ...
   **/
  menu: all.OneOrMany<all.BreweryMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.BreweryHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.BreweryAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.BreweryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.BrewerySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.BreweryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.BreweryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.BreweryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.BreweryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.BreweryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.BreweryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.BreweryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.BreweryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.BreweryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.BreweryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.BreweryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.BreweryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.BreweryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.BreweryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.BrewerySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.BreweryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.BreweryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.BreweryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.BreweryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.BreweryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.BreweryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.BreweryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.BreweryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.BreweryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.BreweryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.BreweryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.BreweryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.BrewerySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.BreweryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.BreweryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.BreweryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.BreweryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.BreweryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.BreweryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.BreweryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.BreweryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.BreweryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.BreweryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.BreweryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.BreweryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.BreweryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.BreweryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.BreweryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.BreweryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.BreweryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.BreweryGeoEqualsFieldEnum>;
}
