 ...
 **/
export type RestaurantAcceptsReservationsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type RestaurantAdditionalTypeFieldEnum = string;
...
export interface Restaurant {
   ...
   **/
  menu: all.OneOrMany<all.RestaurantMenuFieldEnum>;

  /**
   * <https://schema.org/hasMenu>
   **/
  hasMenu: all.OneOrMany<all.RestaurantHasMenuFieldEnum>;

  /**
   * <https://schema.org/acceptsReservations>
   **/
  acceptsReservations: all.OneOrMany<all.RestaurantAcceptsReservationsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.RestaurantUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.RestaurantSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.RestaurantPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.RestaurantKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.RestaurantOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.RestaurantServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.RestaurantKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.RestaurantLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.RestaurantDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.RestaurantLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.RestaurantOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.RestaurantBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.RestaurantKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.RestaurantFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.RestaurantAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.RestaurantCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.RestaurantSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.RestaurantMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.RestaurantDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.RestaurantEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.RestaurantActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.RestaurantAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.RestaurantMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.RestaurantMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.RestaurantAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.RestaurantFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.RestaurantMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.RestaurantIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.RestaurantDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.RestaurantSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.RestaurantAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.RestaurantImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.RestaurantPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.RestaurantGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.RestaurantGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.RestaurantGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.RestaurantGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.RestaurantGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.RestaurantGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.RestaurantLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.RestaurantHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.RestaurantGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.RestaurantGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.RestaurantLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.RestaurantGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.RestaurantGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.RestaurantPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.RestaurantGeoEqualsFieldEnum>;
}
