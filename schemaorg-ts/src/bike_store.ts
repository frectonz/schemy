 ...
 **/
export type BikeStoreAdditionalTypeFieldEnum = string;
...
export interface BikeStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.BikeStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.BikeStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.BikeStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.BikeStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.BikeStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.BikeStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.BikeStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.BikeStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.BikeStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.BikeStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.BikeStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.BikeStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.BikeStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.BikeStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.BikeStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.BikeStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.BikeStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.BikeStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.BikeStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.BikeStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.BikeStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.BikeStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.BikeStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.BikeStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.BikeStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.BikeStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.BikeStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.BikeStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.BikeStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.BikeStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.BikeStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.BikeStoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.BikeStorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.BikeStoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.BikeStoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.BikeStoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.BikeStoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.BikeStoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.BikeStoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.BikeStoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.BikeStoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.BikeStoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.BikeStoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.BikeStoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.BikeStoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.BikeStoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.BikeStorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.BikeStoreGeoEqualsFieldEnum>;
}
