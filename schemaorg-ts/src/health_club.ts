 ...
 **/
export type HealthClubAdditionalTypeFieldEnum = string;
...
export interface HealthClub {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.HealthClubUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.HealthClubSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.HealthClubPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.HealthClubKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.HealthClubOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.HealthClubServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.HealthClubKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.HealthClubLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.HealthClubDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.HealthClubLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.HealthClubOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.HealthClubBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.HealthClubKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.HealthClubFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.HealthClubAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.HealthClubCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.HealthClubSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.HealthClubMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.HealthClubDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.HealthClubEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.HealthClubActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.HealthClubAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.HealthClubMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.HealthClubMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.HealthClubAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.HealthClubFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.HealthClubMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.HealthClubIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.HealthClubDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.HealthClubSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.HealthClubAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.HealthClubImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.HealthClubPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.HealthClubGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.HealthClubGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.HealthClubGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.HealthClubGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.HealthClubGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.HealthClubGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.HealthClubLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.HealthClubHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.HealthClubGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.HealthClubGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.HealthClubLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.HealthClubGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.HealthClubGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.HealthClubPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.HealthClubGeoEqualsFieldEnum>;
}
