 ...
 **/
export type OfferForPurchaseAvailabilityStartsFieldEnum = string;

/**
 * <https://schema.org/gtin>
 **/
export type OfferForPurchaseGtinFieldEnum = string;

/**
 * <https://schema.org/validFrom>
 **/
export type OfferForPurchaseValidFromFieldEnum = string;

/**
 * <https://schema.org/asin>
 **/
export type OfferForPurchaseAsinFieldEnum = string;

/**
 * <https://schema.org/validThrough>
 **/
export type OfferForPurchaseValidThroughFieldEnum = string;

/**
 * <https://schema.org/availabilityEnds>
 **/
export type OfferForPurchaseAvailabilityEndsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type OfferForPurchaseAdditionalTypeFieldEnum = string;
...
export interface OfferForPurchase {
   ...
   **/
  eligibleRegion: all.OneOrMany<all.OfferForPurchaseEligibleRegionFieldEnum>;

  /**
   * <https://schema.org/availabilityStarts>
   **/
  availabilityStarts: all.OneOrMany<all.OfferForPurchaseAvailabilityStartsFieldEnum>;
   ...
   **/
  leaseLength: all.OneOrMany<all.OfferForPurchaseLeaseLengthFieldEnum>;
   ...
   **/
  seller: all.OneOrMany<all.OfferForPurchaseSellerFieldEnum>;
   ...
   * <https://schema.org/gtin>
   **/
  gtin: all.OneOrMany<all.OfferForPurchaseGtinFieldEnum>;

  /**
   * <https://schema.org/price>
   **/
  price: all.OneOrMany<all.OfferForPurchasePriceFieldEnum>;

  /**
   * <https://schema.org/validFrom>
   **/
  validFrom: all.OneOrMany<all.OfferForPurchaseValidFromFieldEnum>;
   ...
   **/
  category: all.OneOrMany<all.OfferForPurchaseCategoryFieldEnum>;

  /**
   * <https://schema.org/asin>
   **/
  asin: all.OneOrMany<all.OfferForPurchaseAsinFieldEnum>;
   ...
   **/
  offeredBy: all.OneOrMany<all.OfferForPurchaseOfferedByFieldEnum>;

  /**
   * <https://schema.org/validThrough>
   **/
  validThrough: all.OneOrMany<all.OfferForPurchaseValidThroughFieldEnum>;
   ...
   **/
  ineligibleRegion: all.OneOrMany<all.OfferForPurchaseIneligibleRegionFieldEnum>;
   ...
   **/
  areaServed: all.OneOrMany<all.OfferForPurchaseAreaServedFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.OfferForPurchaseAcceptedPaymentMethodFieldEnum>;
   ...
   **/
  itemOffered: all.OneOrMany<all.OfferForPurchaseItemOfferedFieldEnum>;

  /**
   * <https://schema.org/availabilityEnds>
   **/
  availabilityEnds: all.OneOrMany<all.OfferForPurchaseAvailabilityEndsFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.OfferForPurchaseMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.OfferForPurchaseIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.OfferForPurchaseDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.OfferForPurchaseSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.OfferForPurchaseAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.OfferForPurchaseImageFieldEnum>;
}
