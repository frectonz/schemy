 ...
 **/
export type GasStationAdditionalTypeFieldEnum = string;
...
export interface GasStation {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.GasStationUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.GasStationSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.GasStationPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.GasStationKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.GasStationOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.GasStationServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.GasStationKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.GasStationLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.GasStationDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.GasStationLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.GasStationOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.GasStationBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.GasStationKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.GasStationFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.GasStationAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.GasStationCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.GasStationSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.GasStationMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.GasStationDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.GasStationEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.GasStationActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.GasStationAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.GasStationMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.GasStationMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.GasStationAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.GasStationFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.GasStationMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.GasStationIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.GasStationDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.GasStationSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.GasStationAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.GasStationImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.GasStationPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.GasStationGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.GasStationGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.GasStationGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.GasStationGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.GasStationGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.GasStationGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.GasStationLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.GasStationHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.GasStationGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.GasStationGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.GasStationLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.GasStationGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.GasStationGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.GasStationPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.GasStationGeoEqualsFieldEnum>;
}
