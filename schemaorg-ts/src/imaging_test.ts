 ...
 **/
export type ImagingTestAdditionalTypeFieldEnum = string;
...
export interface ImagingTest {
   ...
   **/
  imagingTechnique: all.OneOrMany<all.MedicalImagingTechniqueEnum>;
   ...
   **/
  normalRange: all.OneOrMany<all.ImagingTestNormalRangeFieldEnum>;

  /**
   * <https://schema.org/legalStatus>
   **/
  legalStatus: all.OneOrMany<all.ImagingTestLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.ImagingTestMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.ImagingTestIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.ImagingTestDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.ImagingTestSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.ImagingTestAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.ImagingTestImageFieldEnum>;
}
