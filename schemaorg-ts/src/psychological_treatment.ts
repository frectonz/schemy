 ...
 **/
export type PsychologicalTreatmentAdditionalTypeFieldEnum = string;
...
export interface PsychologicalTreatment {
   ...
   **/
  preparation: all.OneOrMany<all.PsychologicalTreatmentPreparationFieldEnum>;

  /**
   * <https://schema.org/status>
   **/
  status: all.OneOrMany<all.PsychologicalTreatmentStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.PsychologicalTreatmentLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PsychologicalTreatmentMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PsychologicalTreatmentIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PsychologicalTreatmentDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PsychologicalTreatmentSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PsychologicalTreatmentAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PsychologicalTreatmentImageFieldEnum>;
}
