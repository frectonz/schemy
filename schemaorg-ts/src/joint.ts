 ...
 **/
export type JointAdditionalTypeFieldEnum = string;
...
export interface Joint {
   ...
   **/
  functionalClass: all.OneOrMany<all.JointFunctionalClassFieldEnum>;

  /**
   * <https://schema.org/structuralClass>
   **/
  structuralClass: all.OneOrMany<string>;

  /**
   * <https://schema.org/biomechnicalClass>
   **/
  biomechnicalClass: all.OneOrMany<string>;
   ...
   **/
  legalStatus: all.OneOrMany<all.JointLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.JointMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.JointIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.JointDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.JointSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.JointAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.JointImageFieldEnum>;
}
