 ...
 **/
export type PhysicianAdditionalTypeFieldEnum = string;
...
export interface Physician {
   ...
   **/
  availableService: all.OneOrMany<all.PhysicianAvailableServiceFieldEnum>;
   ...
   **/
  occupationalCategory: all.OneOrMany<all.PhysicianOccupationalCategoryFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.PhysicianUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.PhysicianSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.PhysicianPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.PhysicianKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.PhysicianOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.PhysicianServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.PhysicianKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.PhysicianLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.PhysicianDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.PhysicianLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.PhysicianOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.PhysicianBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.PhysicianKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.PhysicianFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.PhysicianAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.PhysicianCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.PhysicianSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.PhysicianMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.PhysicianDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.PhysicianEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.PhysicianActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.PhysicianAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.PhysicianMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.PhysicianMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.PhysicianAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.PhysicianFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PhysicianMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PhysicianIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PhysicianDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PhysicianSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PhysicianAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PhysicianImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.PhysicianPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.PhysicianGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.PhysicianGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.PhysicianGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.PhysicianGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.PhysicianGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.PhysicianGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.PhysicianLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.PhysicianHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.PhysicianGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.PhysicianGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.PhysicianLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.PhysicianGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.PhysicianGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.PhysicianPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.PhysicianGeoEqualsFieldEnum>;
