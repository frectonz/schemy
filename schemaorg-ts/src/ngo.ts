 ...
 **/
export type NGOAdditionalTypeFieldEnum = string;
...
export interface NGO {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.NGOUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.NGOSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.NGOPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.NGOKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.NGOOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.NGOServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.NGOKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.NGOLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.NGODiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.NGOLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.NGOOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.NGOBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.NGOKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.NGOFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.NGOAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.NGOCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.NGOSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.NGOMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.NGODiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.NGOEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.NGOActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.NGOAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.NGOMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.NGOMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.NGOAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.NGOFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.NGOMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.NGOIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.NGODescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.NGOSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.NGOAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.NGOImageFieldEnum>;
}
