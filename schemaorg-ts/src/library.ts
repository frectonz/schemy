 ...
 **/
export type LibraryAdditionalTypeFieldEnum = string;
...
export interface Library {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.LibraryUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.LibrarySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.LibraryPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.LibraryKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.LibraryOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.LibraryServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.LibraryKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.LibraryLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.LibraryDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.LibraryLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.LibraryOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.LibraryBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.LibraryKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.LibraryFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.LibraryAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.LibraryCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.LibrarySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.LibraryMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.LibraryDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.LibraryEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.LibraryActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.LibraryAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.LibraryMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.LibraryMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.LibraryAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.LibraryFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.LibraryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.LibraryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.LibraryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.LibrarySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.LibraryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.LibraryImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.LibraryPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.LibraryGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.LibraryGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.LibraryGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.LibraryGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.LibraryGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.LibraryGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.LibraryLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.LibraryHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.LibraryGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.LibraryGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.LibraryLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.LibraryGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.LibraryGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.LibraryPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.LibraryGeoEqualsFieldEnum>;
}
