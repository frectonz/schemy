 ...
 **/
export type MedicalSignOrSymptomAdditionalTypeFieldEnum = string;
...
export interface MedicalSignOrSymptom {
   ...
   **/
  associatedAnatomy: all.OneOrMany<all.MedicalSignOrSymptomAssociatedAnatomyFieldEnum>;
   ...
   **/
  status: all.OneOrMany<all.MedicalSignOrSymptomStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.MedicalSignOrSymptomLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MedicalSignOrSymptomMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MedicalSignOrSymptomIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MedicalSignOrSymptomDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MedicalSignOrSymptomSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MedicalSignOrSymptomAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MedicalSignOrSymptomImageFieldEnum>;
}
