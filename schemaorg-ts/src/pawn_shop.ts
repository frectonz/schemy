 ...
 **/
export type PawnShopAdditionalTypeFieldEnum = string;
...
export interface PawnShop {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.PawnShopUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.PawnShopSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.PawnShopPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.PawnShopKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.PawnShopOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.PawnShopServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.PawnShopKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.PawnShopLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.PawnShopDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.PawnShopLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.PawnShopOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.PawnShopBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.PawnShopKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.PawnShopFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.PawnShopAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.PawnShopCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.PawnShopSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.PawnShopMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.PawnShopDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.PawnShopEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.PawnShopActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.PawnShopAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.PawnShopMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.PawnShopMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.PawnShopAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.PawnShopFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PawnShopMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PawnShopIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PawnShopDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PawnShopSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PawnShopAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PawnShopImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.PawnShopPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.PawnShopGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.PawnShopGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.PawnShopGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.PawnShopGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.PawnShopGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.PawnShopGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.PawnShopLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.PawnShopHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.PawnShopGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.PawnShopGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.PawnShopLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.PawnShopGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.PawnShopGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.PawnShopPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.PawnShopGeoEqualsFieldEnum>;
}
