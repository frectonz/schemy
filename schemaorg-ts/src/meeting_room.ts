 ...
 **/
export type MeetingRoomPetsAllowedFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type MeetingRoomAdditionalTypeFieldEnum = string;
...
export interface MeetingRoom {
   ...
   * <https://schema.org/petsAllowed>
   **/
  petsAllowed: all.OneOrMany<all.MeetingRoomPetsAllowedFieldEnum>;
   ...
   **/
  numberOfBedrooms: all.OneOrMany<all.MeetingRoomNumberOfBedroomsFieldEnum>;
   ...
   **/
  bed: all.OneOrMany<all.MeetingRoomBedFieldEnum>;

  /**
   * <https://schema.org/leaseLength>
   **/
  leaseLength: all.OneOrMany<all.MeetingRoomLeaseLengthFieldEnum>;
   ...
   **/
  numberOfRooms: all.OneOrMany<all.MeetingRoomNumberOfRoomsFieldEnum>;
   ...
   **/
  photos: all.OneOrMany<all.MeetingRoomPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.MeetingRoomGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.MeetingRoomGeoOverlapsFieldEnum>;
   ...
   **/
  geoCrosses: all.OneOrMany<all.MeetingRoomGeoCrossesFieldEnum>;

  /**
   * <https://schema.org/keywords>
   **/
  keywords: all.OneOrMany<all.MeetingRoomKeywordsFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.MeetingRoomGeoCoveredByFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.MeetingRoomLogoFieldEnum>;

  /**
   * <https://schema.org/geoContains>
   **/
  geoContains: all.OneOrMany<all.MeetingRoomGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.MeetingRoomGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.MeetingRoomLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.MeetingRoomHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.MeetingRoomGeoTouchesFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.MeetingRoomAddressFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.MeetingRoomGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.MeetingRoomLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.MeetingRoomGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.MeetingRoomGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.MeetingRoomPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.MeetingRoomGeoEqualsFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MeetingRoomMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MeetingRoomIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MeetingRoomDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MeetingRoomSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MeetingRoomAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MeetingRoomImageFieldEnum>;
}
