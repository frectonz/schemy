 ...
 **/
export type SportsClubAdditionalTypeFieldEnum = string;
...
export interface SportsClub {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.SportsClubUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.SportsClubSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.SportsClubPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.SportsClubKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.SportsClubOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.SportsClubServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.SportsClubKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.SportsClubLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.SportsClubDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.SportsClubLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.SportsClubOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.SportsClubBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.SportsClubKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.SportsClubFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.SportsClubAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.SportsClubCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.SportsClubSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.SportsClubMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.SportsClubDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.SportsClubEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.SportsClubActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.SportsClubAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.SportsClubMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.SportsClubMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.SportsClubAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.SportsClubFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.SportsClubMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.SportsClubIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.SportsClubDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.SportsClubSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.SportsClubAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.SportsClubImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.SportsClubPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.SportsClubGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.SportsClubGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.SportsClubGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.SportsClubGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.SportsClubGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.SportsClubGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.SportsClubLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.SportsClubHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.SportsClubGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.SportsClubGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.SportsClubLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.SportsClubGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.SportsClubGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.SportsClubPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.SportsClubGeoEqualsFieldEnum>;
}
