 ...
 **/
export type DiagnosticLabAdditionalTypeFieldEnum = string;
...
export interface DiagnosticLab {
   ...
   **/
  availableTest: all.OneOrMany<all.MedicalTest>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.DiagnosticLabUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.DiagnosticLabSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.DiagnosticLabPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.DiagnosticLabKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.DiagnosticLabOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.DiagnosticLabServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.DiagnosticLabKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.DiagnosticLabLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.DiagnosticLabDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.DiagnosticLabLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.DiagnosticLabOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.DiagnosticLabBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.DiagnosticLabKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.DiagnosticLabFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.DiagnosticLabAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.DiagnosticLabCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.DiagnosticLabSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.DiagnosticLabMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.DiagnosticLabDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.DiagnosticLabEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.DiagnosticLabActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.DiagnosticLabAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.DiagnosticLabMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.DiagnosticLabMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.DiagnosticLabAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.DiagnosticLabFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.DiagnosticLabMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.DiagnosticLabIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.DiagnosticLabDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.DiagnosticLabSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.DiagnosticLabAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.DiagnosticLabImageFieldEnum>;
}
