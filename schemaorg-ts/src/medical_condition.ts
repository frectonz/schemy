 ...
 **/
export type MedicalConditionAdditionalTypeFieldEnum = string;
...
export interface MedicalCondition {
   ...
   **/
  associatedAnatomy: all.OneOrMany<all.MedicalConditionAssociatedAnatomyFieldEnum>;
   ...
   **/
  status: all.OneOrMany<all.MedicalConditionStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.MedicalConditionLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MedicalConditionMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MedicalConditionIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MedicalConditionDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MedicalConditionSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MedicalConditionAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MedicalConditionImageFieldEnum>;
}
