 ...
 **/
export type ToyStoreAdditionalTypeFieldEnum = string;
...
export interface ToyStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.ToyStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.ToyStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.ToyStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.ToyStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.ToyStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.ToyStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.ToyStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.ToyStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.ToyStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.ToyStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.ToyStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.ToyStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.ToyStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.ToyStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.ToyStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.ToyStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.ToyStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.ToyStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.ToyStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.ToyStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.ToyStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.ToyStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.ToyStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.ToyStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.ToyStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.ToyStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.ToyStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.ToyStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.ToyStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.ToyStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.ToyStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.ToyStoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.ToyStorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.ToyStoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.ToyStoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.ToyStoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.ToyStoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.ToyStoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.ToyStoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.ToyStoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.ToyStoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.ToyStoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.ToyStoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.ToyStoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.ToyStoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.ToyStoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.ToyStorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.ToyStoreGeoEqualsFieldEnum>;
}
