 ...
 **/
export type HostelPetsAllowedFieldEnum = string;

/**
 * <https://schema.org/checkoutTime>
 **/
export type HostelCheckoutTimeFieldEnum = string;

/**
 * <https://schema.org/checkinTime>
 **/
export type HostelCheckinTimeFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type HostelAdditionalTypeFieldEnum = string;
...
export interface Hostel {
   ...
   * <https://schema.org/petsAllowed>
   **/
  petsAllowed: all.OneOrMany<all.HostelPetsAllowedFieldEnum>;

  /**
   * <https://schema.org/availableLanguage>
   **/
  availableLanguage: all.OneOrMany<all.HostelAvailableLanguageFieldEnum>;

  /**
   * <https://schema.org/checkoutTime>
   **/
  checkoutTime: all.OneOrMany<all.HostelCheckoutTimeFieldEnum>;

  /**
   * <https://schema.org/checkinTime>
   **/
  checkinTime: all.OneOrMany<all.HostelCheckinTimeFieldEnum>;

  /**
   * <https://schema.org/numberOfRooms>
   **/
  numberOfRooms: all.OneOrMany<all.HostelNumberOfRoomsFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.HostelUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.HostelSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.HostelPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.HostelKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.HostelOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.HostelServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.HostelKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.HostelLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.HostelDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.HostelLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.HostelOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.HostelBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.HostelKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.HostelFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.HostelAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.HostelCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.HostelSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.HostelMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.HostelDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.HostelEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.HostelActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.HostelAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.HostelMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.HostelMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.HostelAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.HostelFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.HostelMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.HostelIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.HostelDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.HostelSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.HostelAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.HostelImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.HostelPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.HostelGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.HostelGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.HostelGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.HostelGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.HostelGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.HostelGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.HostelLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.HostelHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.HostelGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.HostelGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.HostelLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.HostelGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.HostelGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.HostelPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.HostelGeoEqualsFieldEnum>;
}
