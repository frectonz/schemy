 ...
 **/
export type ArteryAdditionalTypeFieldEnum = string;
...
export interface Artery {
   ...
   **/
  arterialBranch: all.OneOrMany<all.AnatomicalStructure>;

  /**
   * <https://schema.org/supplyTo>
   **/
  supplyTo: all.OneOrMany<all.AnatomicalStructure>;
   ...
   **/
  legalStatus: all.OneOrMany<all.ArteryLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.ArteryMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.ArteryIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.ArteryDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.ArterySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.ArteryAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.ArteryImageFieldEnum>;
}
