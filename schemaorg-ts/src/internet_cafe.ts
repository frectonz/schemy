 ...
 **/
export type InternetCafeAdditionalTypeFieldEnum = string;
...
export interface InternetCafe {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.InternetCafeUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.InternetCafeSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.InternetCafePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.InternetCafeKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.InternetCafeOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.InternetCafeServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.InternetCafeKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.InternetCafeLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.InternetCafeDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.InternetCafeLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.InternetCafeOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.InternetCafeBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.InternetCafeKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.InternetCafeFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.InternetCafeAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.InternetCafeCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.InternetCafeSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.InternetCafeMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.InternetCafeDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.InternetCafeEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.InternetCafeActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.InternetCafeAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.InternetCafeMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.InternetCafeMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.InternetCafeAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.InternetCafeFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.InternetCafeMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.InternetCafeIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.InternetCafeDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.InternetCafeSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.InternetCafeAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.InternetCafeImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.InternetCafePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.InternetCafeGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.InternetCafeGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.InternetCafeGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.InternetCafeGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.InternetCafeGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.InternetCafeGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.InternetCafeLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.InternetCafeHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.InternetCafeGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.InternetCafeGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.InternetCafeLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.InternetCafeGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.InternetCafeGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.InternetCafePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.InternetCafeGeoEqualsFieldEnum>;
}
