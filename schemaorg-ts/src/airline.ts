 ...
 **/
export type AirlineAdditionalTypeFieldEnum = string;
...
export interface Airline {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.AirlineUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.AirlineSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.AirlinePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.AirlineKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.AirlineOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.AirlineServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.AirlineKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.AirlineLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.AirlineDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.AirlineLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.AirlineOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.AirlineBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.AirlineKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.AirlineFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.AirlineAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.AirlineCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.AirlineSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.AirlineMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.AirlineDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.AirlineEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.AirlineActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.AirlineAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.AirlineMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.AirlineMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.AirlineAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.AirlineFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AirlineMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AirlineIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AirlineDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AirlineSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AirlineAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AirlineImageFieldEnum>;
}
