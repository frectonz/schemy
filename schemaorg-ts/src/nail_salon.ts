 ...
 **/
export type NailSalonAdditionalTypeFieldEnum = string;
...
export interface NailSalon {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.NailSalonUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.NailSalonSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.NailSalonPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.NailSalonKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.NailSalonOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.NailSalonServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.NailSalonKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.NailSalonLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.NailSalonDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.NailSalonLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.NailSalonOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.NailSalonBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.NailSalonKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.NailSalonFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.NailSalonAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.NailSalonCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.NailSalonSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.NailSalonMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.NailSalonDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.NailSalonEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.NailSalonActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.NailSalonAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.NailSalonMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.NailSalonMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.NailSalonAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.NailSalonFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.NailSalonMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.NailSalonIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.NailSalonDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.NailSalonSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.NailSalonAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.NailSalonImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.NailSalonPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.NailSalonGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.NailSalonGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.NailSalonGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.NailSalonGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.NailSalonGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.NailSalonGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.NailSalonLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.NailSalonHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.NailSalonGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.NailSalonGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.NailSalonLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.NailSalonGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.NailSalonGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.NailSalonPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.NailSalonGeoEqualsFieldEnum>;
}
