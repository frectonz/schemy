 ...
 **/
export type OnlineStoreAdditionalTypeFieldEnum = string;
...
export interface OnlineStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.OnlineStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.OnlineStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.OnlineStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.OnlineStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.OnlineStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.OnlineStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.OnlineStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.OnlineStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.OnlineStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.OnlineStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.OnlineStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.OnlineStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.OnlineStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.OnlineStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.OnlineStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.OnlineStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.OnlineStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.OnlineStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.OnlineStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.OnlineStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.OnlineStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.OnlineStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.OnlineStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.OnlineStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.OnlineStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.OnlineStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.OnlineStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.OnlineStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.OnlineStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.OnlineStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.OnlineStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.OnlineStoreImageFieldEnum>;
}
