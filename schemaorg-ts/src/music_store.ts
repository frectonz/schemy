 ...
 **/
export type MusicStoreAdditionalTypeFieldEnum = string;
...
export interface MusicStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.MusicStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.MusicStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.MusicStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.MusicStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.MusicStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.MusicStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.MusicStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.MusicStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.MusicStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.MusicStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.MusicStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.MusicStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.MusicStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.MusicStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.MusicStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.MusicStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.MusicStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.MusicStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.MusicStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.MusicStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.MusicStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.MusicStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.MusicStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.MusicStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.MusicStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.MusicStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MusicStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MusicStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MusicStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MusicStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MusicStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MusicStoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.MusicStorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.MusicStoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.MusicStoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.MusicStoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.MusicStoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.MusicStoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.MusicStoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.MusicStoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.MusicStoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.MusicStoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.MusicStoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.MusicStoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.MusicStoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.MusicStoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.MusicStorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.MusicStoreGeoEqualsFieldEnum>;
}
