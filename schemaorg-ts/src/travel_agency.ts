 ...
 **/
export type TravelAgencyAdditionalTypeFieldEnum = string;
...
export interface TravelAgency {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.TravelAgencyUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.TravelAgencySkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.TravelAgencyPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.TravelAgencyKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.TravelAgencyOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.TravelAgencyServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.TravelAgencyKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.TravelAgencyLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.TravelAgencyDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.TravelAgencyLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.TravelAgencyOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.TravelAgencyBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.TravelAgencyKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.TravelAgencyFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.TravelAgencyAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.TravelAgencyCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.TravelAgencySponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.TravelAgencyMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.TravelAgencyDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.TravelAgencyEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.TravelAgencyActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.TravelAgencyAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.TravelAgencyMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.TravelAgencyMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.TravelAgencyAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.TravelAgencyFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.TravelAgencyMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.TravelAgencyIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.TravelAgencyDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.TravelAgencySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.TravelAgencyAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.TravelAgencyImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.TravelAgencyPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.TravelAgencyGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.TravelAgencyGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.TravelAgencyGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.TravelAgencyGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.TravelAgencyGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.TravelAgencyGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.TravelAgencyLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.TravelAgencyHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.TravelAgencyGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.TravelAgencyGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.TravelAgencyLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.TravelAgencyGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.TravelAgencyGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.TravelAgencyPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.TravelAgencyGeoEqualsFieldEnum>;
}
