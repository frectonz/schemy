 ...
 **/
export type LigamentAdditionalTypeFieldEnum = string;
...
export interface Ligament {
   ...
   **/
  legalStatus: all.OneOrMany<all.LigamentLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.LigamentMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.LigamentIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.LigamentDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.LigamentSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.LigamentAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.LigamentImageFieldEnum>;
}
