 ...
 **/
export type NightClubAdditionalTypeFieldEnum = string;
...
export interface NightClub {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.NightClubUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.NightClubSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.NightClubPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.NightClubKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.NightClubOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.NightClubServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.NightClubKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.NightClubLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.NightClubDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.NightClubLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.NightClubOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.NightClubBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.NightClubKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.NightClubFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.NightClubAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.NightClubCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.NightClubSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.NightClubMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.NightClubDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.NightClubEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.NightClubActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.NightClubAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.NightClubMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.NightClubMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.NightClubAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.NightClubFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.NightClubMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.NightClubIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.NightClubDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.NightClubSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.NightClubAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.NightClubImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.NightClubPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.NightClubGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.NightClubGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.NightClubGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.NightClubGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.NightClubGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.NightClubGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.NightClubLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.NightClubHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.NightClubGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.NightClubGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.NightClubLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.NightClubGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.NightClubGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.NightClubPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.NightClubGeoEqualsFieldEnum>;
}
