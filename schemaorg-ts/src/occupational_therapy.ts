 ...
 **/
export type OccupationalTherapyAdditionalTypeFieldEnum = string;
...
export interface OccupationalTherapy {
   ...
   **/
  contraindication: all.OneOrMany<all.OccupationalTherapyContraindicationFieldEnum>;
   ...
   **/
  preparation: all.OneOrMany<all.OccupationalTherapyPreparationFieldEnum>;

  /**
   * <https://schema.org/status>
   **/
  status: all.OneOrMany<all.OccupationalTherapyStatusFieldEnum>;
   ...
   **/
  legalStatus: all.OneOrMany<all.OccupationalTherapyLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.OccupationalTherapyMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.OccupationalTherapyIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.OccupationalTherapyDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.OccupationalTherapySubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.OccupationalTherapyAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.OccupationalTherapyImageFieldEnum>;
}
