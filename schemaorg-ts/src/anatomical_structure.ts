 ...
 **/
export type AnatomicalStructureAdditionalTypeFieldEnum = string;
...
export interface AnatomicalStructure {
   ...
   **/
  legalStatus: all.OneOrMany<all.AnatomicalStructureLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AnatomicalStructureMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AnatomicalStructureIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AnatomicalStructureDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AnatomicalStructureSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AnatomicalStructureAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AnatomicalStructureImageFieldEnum>;
}
