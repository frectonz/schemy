 ...
 **/
export type PostOfficeAdditionalTypeFieldEnum = string;
...
export interface PostOffice {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.PostOfficeUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.PostOfficeSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.PostOfficePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.PostOfficeKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.PostOfficeOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.PostOfficeServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.PostOfficeKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.PostOfficeLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.PostOfficeDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.PostOfficeLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.PostOfficeOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.PostOfficeBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.PostOfficeKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.PostOfficeFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.PostOfficeAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.PostOfficeCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.PostOfficeSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.PostOfficeMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.PostOfficeDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.PostOfficeEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.PostOfficeActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.PostOfficeAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.PostOfficeMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.PostOfficeMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.PostOfficeAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.PostOfficeFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PostOfficeMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PostOfficeIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PostOfficeDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PostOfficeSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PostOfficeAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PostOfficeImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.PostOfficePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.PostOfficeGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.PostOfficeGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.PostOfficeGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.PostOfficeGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.PostOfficeGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.PostOfficeGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.PostOfficeLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.PostOfficeHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.PostOfficeGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.PostOfficeGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.PostOfficeLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.PostOfficeGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.PostOfficeGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.PostOfficePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.PostOfficeGeoEqualsFieldEnum>;
}
