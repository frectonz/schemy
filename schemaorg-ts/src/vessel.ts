 ...
 **/
export type VesselAdditionalTypeFieldEnum = string;
...
export interface Vessel {
   ...
   **/
  legalStatus: all.OneOrMany<all.VesselLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.VesselMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.VesselIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.VesselDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.VesselSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.VesselAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.VesselImageFieldEnum>;
}
