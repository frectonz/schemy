 ...
 **/
export type TireShopAdditionalTypeFieldEnum = string;
...
export interface TireShop {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.TireShopUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.TireShopSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.TireShopPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.TireShopKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.TireShopOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.TireShopServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.TireShopKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.TireShopLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.TireShopDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.TireShopLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.TireShopOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.TireShopBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.TireShopKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.TireShopFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.TireShopAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.TireShopCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.TireShopSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.TireShopMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.TireShopDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.TireShopEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.TireShopActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.TireShopAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.TireShopMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.TireShopMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.TireShopAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.TireShopFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.TireShopMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.TireShopIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.TireShopDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.TireShopSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.TireShopAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.TireShopImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.TireShopPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.TireShopGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.TireShopGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.TireShopGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.TireShopGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.TireShopGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.TireShopGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.TireShopLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.TireShopHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.TireShopGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.TireShopGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.TireShopLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.TireShopGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.TireShopGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.TireShopPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.TireShopGeoEqualsFieldEnum>;
}
