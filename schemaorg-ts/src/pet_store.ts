 ...
 **/
export type PetStoreAdditionalTypeFieldEnum = string;
...
export interface PetStore {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.PetStoreUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.PetStoreSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.PetStorePublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.PetStoreKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.PetStoreOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.PetStoreServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.PetStoreKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.PetStoreLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.PetStoreDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.PetStoreLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.PetStoreOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.PetStoreBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.PetStoreKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.PetStoreFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.PetStoreAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.PetStoreCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.PetStoreSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.PetStoreMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.PetStoreDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.PetStoreEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.PetStoreActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.PetStoreAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.PetStoreMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.PetStoreMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.PetStoreAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.PetStoreFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.PetStoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.PetStoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.PetStoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.PetStoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.PetStoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.PetStoreImageFieldEnum>;

  /**
   * <https://schema.org/photos>
   **/
  photos: all.OneOrMany<all.PetStorePhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.PetStoreGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.PetStoreGeoOverlapsFieldEnum>;

  /**
   * <https://schema.org/geoCrosses>
   **/
  geoCrosses: all.OneOrMany<all.PetStoreGeoCrossesFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.PetStoreGeoCoveredByFieldEnum>;
   ...
   **/
  geoContains: all.OneOrMany<all.PetStoreGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.PetStoreGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.PetStoreLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.PetStoreHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.PetStoreGeoTouchesFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.PetStoreGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.PetStoreLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.PetStoreGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.PetStoreGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.PetStorePhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.PetStoreGeoEqualsFieldEnum>;
}
