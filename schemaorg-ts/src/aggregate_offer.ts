 ...
 **/
export type AggregateOfferAvailabilityStartsFieldEnum = string;

/**
 * <https://schema.org/gtin>
 **/
export type AggregateOfferGtinFieldEnum = string;

/**
 * <https://schema.org/validFrom>
 **/
export type AggregateOfferValidFromFieldEnum = string;

/**
 * <https://schema.org/asin>
 **/
export type AggregateOfferAsinFieldEnum = string;

/**
 * <https://schema.org/validThrough>
 **/
export type AggregateOfferValidThroughFieldEnum = string;

/**
 * <https://schema.org/availabilityEnds>
 **/
export type AggregateOfferAvailabilityEndsFieldEnum = string;

/**
 * <https://schema.org/additionalType>
 **/
export type AggregateOfferAdditionalTypeFieldEnum = string;
...
export interface AggregateOffer {
   ...
   **/
  highPrice: all.OneOrMany<all.AggregateOfferHighPriceFieldEnum>;

  /**
   * <https://schema.org/offers>
   **/
  offers: all.OneOrMany<all.AggregateOfferOffersFieldEnum>;

  /**
   * <https://schema.org/offerCount>
   **/
  offerCount: all.OneOrMany<number>;

  /**
   * <https://schema.org/lowPrice>
   **/
  lowPrice: all.OneOrMany<all.AggregateOfferLowPriceFieldEnum>;
   ...
   **/
  eligibleRegion: all.OneOrMany<all.AggregateOfferEligibleRegionFieldEnum>;

  /**
   * <https://schema.org/availabilityStarts>
   **/
  availabilityStarts: all.OneOrMany<all.AggregateOfferAvailabilityStartsFieldEnum>;
   ...
   **/
  leaseLength: all.OneOrMany<all.AggregateOfferLeaseLengthFieldEnum>;
   ...
   **/
  seller: all.OneOrMany<all.AggregateOfferSellerFieldEnum>;
   ...
   * <https://schema.org/gtin>
   **/
  gtin: all.OneOrMany<all.AggregateOfferGtinFieldEnum>;

  /**
   * <https://schema.org/price>
   **/
  price: all.OneOrMany<all.AggregateOfferPriceFieldEnum>;

  /**
   * <https://schema.org/validFrom>
   **/
  validFrom: all.OneOrMany<all.AggregateOfferValidFromFieldEnum>;
   ...
   **/
  category: all.OneOrMany<all.AggregateOfferCategoryFieldEnum>;

  /**
   * <https://schema.org/asin>
   **/
  asin: all.OneOrMany<all.AggregateOfferAsinFieldEnum>;
   ...
   **/
  offeredBy: all.OneOrMany<all.AggregateOfferOfferedByFieldEnum>;

  /**
   * <https://schema.org/validThrough>
   **/
  validThrough: all.OneOrMany<all.AggregateOfferValidThroughFieldEnum>;
   ...
   **/
  ineligibleRegion: all.OneOrMany<all.AggregateOfferIneligibleRegionFieldEnum>;
   ...
   **/
  areaServed: all.OneOrMany<all.AggregateOfferAreaServedFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.AggregateOfferAcceptedPaymentMethodFieldEnum>;
   ...
   **/
  itemOffered: all.OneOrMany<all.AggregateOfferItemOfferedFieldEnum>;

  /**
   * <https://schema.org/availabilityEnds>
   **/
  availabilityEnds: all.OneOrMany<all.AggregateOfferAvailabilityEndsFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.AggregateOfferMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.AggregateOfferIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.AggregateOfferDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.AggregateOfferSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.AggregateOfferAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.AggregateOfferImageFieldEnum>;
}
