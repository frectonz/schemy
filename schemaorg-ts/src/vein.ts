 ...
 **/
export type VeinAdditionalTypeFieldEnum = string;
...
export interface Vein {
   ...
   **/
  regionDrained: all.OneOrMany<all.VeinRegionDrainedFieldEnum>;

  /**
   * <https://schema.org/drainsTo>
   **/
  drainsTo: all.OneOrMany<all.Vessel>;

  /**
   * <https://schema.org/tributary>
   **/
  tributary: all.OneOrMany<all.AnatomicalStructure>;
   ...
   **/
  legalStatus: all.OneOrMany<all.VeinLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.VeinMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.VeinIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.VeinDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.VeinSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.VeinAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.VeinImageFieldEnum>;
}
