 ...
 **/
export type MovieTheaterAdditionalTypeFieldEnum = string;
...
export interface MovieTheater {
   ...
   **/
  screenCount: all.OneOrMany<number>;
   ...
   **/
  photos: all.OneOrMany<all.MovieTheaterPhotosFieldEnum>;
   ...
   **/
  geoIntersects: all.OneOrMany<all.MovieTheaterGeoIntersectsFieldEnum>;
   ...
   **/
  geoOverlaps: all.OneOrMany<all.MovieTheaterGeoOverlapsFieldEnum>;
   ...
   **/
  geoCrosses: all.OneOrMany<all.MovieTheaterGeoCrossesFieldEnum>;

  /**
   * <https://schema.org/keywords>
   **/
  keywords: all.OneOrMany<all.MovieTheaterKeywordsFieldEnum>;
   ...
   **/
  geoCoveredBy: all.OneOrMany<all.MovieTheaterGeoCoveredByFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.MovieTheaterLogoFieldEnum>;

  /**
   * <https://schema.org/geoContains>
   **/
  geoContains: all.OneOrMany<all.MovieTheaterGeoContainsFieldEnum>;

  /**
   * <https://schema.org/geo>
   **/
  geo: all.OneOrMany<all.MovieTheaterGeoFieldEnum>;
   ...
   **/
  latitude: all.OneOrMany<all.MovieTheaterLatitudeFieldEnum>;
   ...
   **/
  hasMap: all.OneOrMany<all.MovieTheaterHasMapFieldEnum>;

  /**
   * <https://schema.org/geoTouches>
   **/
  geoTouches: all.OneOrMany<all.MovieTheaterGeoTouchesFieldEnum>;
   ...
   **/
  address: all.OneOrMany<all.MovieTheaterAddressFieldEnum>;
   ...
   **/
  geoWithin: all.OneOrMany<all.MovieTheaterGeoWithinFieldEnum>;
   ...
   **/
  longitude: all.OneOrMany<all.MovieTheaterLongitudeFieldEnum>;

  /**
   * <https://schema.org/geoDisjoint>
   **/
  geoDisjoint: all.OneOrMany<all.MovieTheaterGeoDisjointFieldEnum>;

  /**
   * <https://schema.org/geoCovers>
   **/
  geoCovers: all.OneOrMany<all.MovieTheaterGeoCoversFieldEnum>;
   ...
   **/
  photo: all.OneOrMany<all.MovieTheaterPhotoFieldEnum>;
   ...
   **/
  geoEquals: all.OneOrMany<all.MovieTheaterGeoEqualsFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MovieTheaterMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MovieTheaterIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MovieTheaterDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MovieTheaterSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MovieTheaterAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MovieTheaterImageFieldEnum>;
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.MovieTheaterUnnamedSourcesPolicyFieldEnum>;

  /**
   * <https://schema.org/skills>
   **/
  skills: all.OneOrMany<all.MovieTheaterSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.MovieTheaterPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.MovieTheaterKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.MovieTheaterOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.MovieTheaterServiceAreaFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.MovieTheaterLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.MovieTheaterDiversityPolicyFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.MovieTheaterOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.MovieTheaterBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.MovieTheaterKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.MovieTheaterFunderFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.MovieTheaterCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.MovieTheaterSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.MovieTheaterMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.MovieTheaterDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.MovieTheaterEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.MovieTheaterActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.MovieTheaterAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.MovieTheaterMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.MovieTheaterMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.MovieTheaterAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.MovieTheaterFounderFieldEnum>;
