 ...
 **/
export type MuscleAdditionalTypeFieldEnum = string;
...
export interface Muscle {
   ...
   **/
  antagonist: all.OneOrMany<all.Muscle>;

  /**
   * <https://schema.org/nerve>
   **/
  nerve: all.OneOrMany<all.Nerve>;

  /**
   * <https://schema.org/bloodSupply>
   **/
  bloodSupply: all.OneOrMany<all.Vessel>;

  /**
   * <https://schema.org/muscleAction>
   **/
  muscleAction: all.OneOrMany<string>;

  /**
   * <https://schema.org/insertion>
   **/
  insertion: all.OneOrMany<all.AnatomicalStructure>;
   ...
   **/
  legalStatus: all.OneOrMany<all.MuscleLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MuscleMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MuscleIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MuscleDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MuscleSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MuscleAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MuscleImageFieldEnum>;
}
