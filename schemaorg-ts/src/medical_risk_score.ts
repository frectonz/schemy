 ...
 **/
export type MedicalRiskScoreAdditionalTypeFieldEnum = string;
...
export interface MedicalRiskScore {
   ...
   **/
  algorithm: all.OneOrMany<string>;
   ...
   **/
  legalStatus: all.OneOrMany<all.MedicalRiskScoreLegalStatusFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.MedicalRiskScoreMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.MedicalRiskScoreIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.MedicalRiskScoreDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.MedicalRiskScoreSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.MedicalRiskScoreAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.MedicalRiskScoreImageFieldEnum>;
}
