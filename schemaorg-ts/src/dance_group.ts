 ...
 **/
export type DanceGroupAdditionalTypeFieldEnum = string;
...
export interface DanceGroup {
   ...
   **/
  unnamedSourcesPolicy: all.OneOrMany<all.DanceGroupUnnamedSourcesPolicyFieldEnum>;
   ...
   **/
  skills: all.OneOrMany<all.DanceGroupSkillsFieldEnum>;

  /**
   * <https://schema.org/publishingPrinciples>
   **/
  publishingPrinciples: all.OneOrMany<all.DanceGroupPublishingPrinciplesFieldEnum>;
   ...
   **/
  knowsAbout: all.OneOrMany<all.DanceGroupKnowsAboutFieldEnum>;
   ...
   **/
  ownershipFundingInfo: all.OneOrMany<all.DanceGroupOwnershipFundingInfoFieldEnum>;
   ...
   **/
  serviceArea: all.OneOrMany<all.DanceGroupServiceAreaFieldEnum>;
   ...
   **/
  keywords: all.OneOrMany<all.DanceGroupKeywordsFieldEnum>;
   ...
   **/
  location: all.OneOrMany<all.DanceGroupLocationFieldEnum>;
   ...
   **/
  diversityPolicy: all.OneOrMany<all.DanceGroupDiversityPolicyFieldEnum>;
   ...
   **/
  logo: all.OneOrMany<all.DanceGroupLogoFieldEnum>;
   ...
   **/
  owns: all.OneOrMany<all.DanceGroupOwnsFieldEnum>;
   ...
   **/
  brand: all.OneOrMany<all.DanceGroupBrandFieldEnum>;

  /**
   * <https://schema.org/knowsLanguage>
   **/
  knowsLanguage: all.OneOrMany<all.DanceGroupKnowsLanguageFieldEnum>;
   ...
   **/
  funder: all.OneOrMany<all.DanceGroupFunderFieldEnum>;

  /**
   * <https://schema.org/address>
   **/
  address: all.OneOrMany<all.DanceGroupAddressFieldEnum>;
   ...
   **/
  correctionsPolicy: all.OneOrMany<all.DanceGroupCorrectionsPolicyFieldEnum>;
   ...
   **/
  sponsor: all.OneOrMany<all.DanceGroupSponsorFieldEnum>;

  /**
   * <https://schema.org/memberOf>
   **/
  memberOf: all.OneOrMany<all.DanceGroupMemberOfFieldEnum>;
   ...
   **/
  diversityStaffingReport: all.OneOrMany<all.DanceGroupDiversityStaffingReportFieldEnum>;
   ...
   **/
  ethicsPolicy: all.OneOrMany<all.DanceGroupEthicsPolicyFieldEnum>;

  /**
   * <https://schema.org/actionableFeedbackPolicy>
   **/
  actionableFeedbackPolicy: all.OneOrMany<all.DanceGroupActionableFeedbackPolicyFieldEnum>;

  /**
   * <https://schema.org/areaServed>
   **/
  areaServed: all.OneOrMany<all.DanceGroupAreaServedFieldEnum>;

  /**
   * <https://schema.org/members>
   **/
  members: all.OneOrMany<all.DanceGroupMembersFieldEnum>;

  /**
   * <https://schema.org/member>
   **/
  member: all.OneOrMany<all.DanceGroupMemberFieldEnum>;
   ...
   **/
  acceptedPaymentMethod: all.OneOrMany<all.DanceGroupAcceptedPaymentMethodFieldEnum>;

  /**
   * <https://schema.org/founder>
   **/
  founder: all.OneOrMany<all.DanceGroupFounderFieldEnum>;
   ...
   **/
  mainEntityOfPage: all.OneOrMany<all.DanceGroupMainEntityOfPageFieldEnum>;
   ...
   **/
  identifier: all.OneOrMany<all.DanceGroupIdentifierFieldEnum>;

  /**
   * <https://schema.org/description>
   **/
  description: all.OneOrMany<all.DanceGroupDescriptionFieldEnum>;

  /**
   * <https://schema.org/subjectOf>
   **/
  subjectOf: all.OneOrMany<all.DanceGroupSubjectOfFieldEnum>;
   ...
   * <https://schema.org/additionalType>
   **/
  additionalType: all.OneOrMany<all.DanceGroupAdditionalTypeFieldEnum>;
   ...
   **/
  image: all.OneOrMany<all.DanceGroupImageFieldEnum>;
}
