...
pub type GovernmentBenefitsTypeAdditionalTypeFieldEnum = String;
...
pub struct GovernmentBenefitsType {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<GovernmentBenefitsTypeAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<GovernmentBenefitsTypeImageFieldEnum>,
}
