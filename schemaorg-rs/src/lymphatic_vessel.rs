...
pub type LymphaticVesselAdditionalTypeFieldEnum = String;
...
pub struct LymphaticVessel {
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<LymphaticVesselImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<LymphaticVesselDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<LymphaticVesselLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<LymphaticVesselIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<LymphaticVesselAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<LymphaticVesselSubjectOfFieldEnum>,
    ...
    #[serde(rename = "originatesFrom")]
    #[serde_as(as = "OneOrMany<_>")]
    pub originates_from: Vec<Vessel>,
    ///https://schema.org/regionDrained
    #[serde(rename = "regionDrained")]
    #[serde_as(as = "OneOrMany<_>")]
    pub region_drained: Vec<LymphaticVesselRegionDrainedFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<LymphaticVesselMainEntityOfPageFieldEnum>,
