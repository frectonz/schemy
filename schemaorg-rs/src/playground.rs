...
pub type PlaygroundAdditionalTypeFieldEnum = String;
...
pub struct Playground {
    ...
    pub geo_touches: Vec<PlaygroundGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<PlaygroundKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<PlaygroundDescriptionFieldEnum>,
    ///<https://schema.org/geoIntersects>
    #[serde(rename = "geoIntersects")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<PlaygroundGeoIntersectsFieldEnum>,
    ///<https://schema.org/geoCoveredBy>
    #[serde(rename = "geoCoveredBy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<PlaygroundGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<PlaygroundGeoContainsFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<PlaygroundPhotoFieldEnum>,
    ///<https://schema.org/mainEntityOfPage>
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<PlaygroundMainEntityOfPageFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<PlaygroundHasMapFieldEnum>,
    ///<https://schema.org/geoEquals>
    #[serde(rename = "geoEquals")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<PlaygroundGeoEqualsFieldEnum>,
    ///<https://schema.org/additionalType>
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<PlaygroundAdditionalTypeFieldEnum>,
    ///<https://schema.org/geoOverlaps>
    #[serde(rename = "geoOverlaps")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<PlaygroundGeoOverlapsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<PlaygroundGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<PlaygroundLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<PlaygroundLongitudeFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<PlaygroundGeoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<PlaygroundGeoCoversFieldEnum>,
    ...
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<PlaygroundPhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<PlaygroundIdentifierFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<PlaygroundImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<PlaygroundGeoCrossesFieldEnum>,
    ///<https://schema.org/geoDisjoint>
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<PlaygroundGeoDisjointFieldEnum>,
    ///<https://schema.org/logo>
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<PlaygroundLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<PlaygroundSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<PlaygroundAddressFieldEnum>,
}
