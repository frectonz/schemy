...
pub type ApartmentPetsAllowedFieldEnum = String;
///<https://schema.org/additionalType>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type ApartmentAdditionalTypeFieldEnum = String;
...
pub struct Apartment {
    ...
    pub logo: Vec<ApartmentLogoFieldEnum>,
    ...
    #[serde(rename = "bed")]
    #[serde_as(as = "OneOrMany<_>")]
    pub bed: Vec<ApartmentBedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<ApartmentGeoCoveredByFieldEnum>,
    ///<https://schema.org/mainEntityOfPage>
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<ApartmentMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<ApartmentGeoEqualsFieldEnum>,
    ///<https://schema.org/petsAllowed>
    #[serde(rename = "petsAllowed")]
    #[serde_as(as = "OneOrMany<_>")]
    pub pets_allowed: Vec<ApartmentPetsAllowedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<ApartmentKeywordsFieldEnum>,
    ...
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<ApartmentPhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<ApartmentLongitudeFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<ApartmentDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub number_of_bedrooms: Vec<ApartmentNumberOfBedroomsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub number_of_rooms: Vec<ApartmentNumberOfRoomsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<ApartmentAddressFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<ApartmentImageFieldEnum>,
    ///<https://schema.org/geoIntersects>
    #[serde(rename = "geoIntersects")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<ApartmentGeoIntersectsFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<ApartmentGeoFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<ApartmentSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<ApartmentGeoContainsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<ApartmentGeoCoversFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<ApartmentGeoDisjointFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<ApartmentGeoOverlapsFieldEnum>,
    ///<https://schema.org/geoCrosses>
    #[serde(rename = "geoCrosses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<ApartmentGeoCrossesFieldEnum>,
    ///<https://schema.org/photo>
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<ApartmentPhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<ApartmentIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<ApartmentGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<ApartmentAdditionalTypeFieldEnum>,
    ///<https://schema.org/leaseLength>
    #[serde(rename = "leaseLength")]
    #[serde_as(as = "OneOrMany<_>")]
    pub lease_length: Vec<ApartmentLeaseLengthFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<ApartmentGeoTouchesFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<ApartmentHasMapFieldEnum>,
    ///<https://schema.org/latitude>
    #[serde(rename = "latitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<ApartmentLatitudeFieldEnum>,
}
