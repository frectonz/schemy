...
pub type FastFoodRestaurantAdditionalTypeFieldEnum = String;
///<https://schema.org/acceptsReservations>
///<https://schema.org/Boolean>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type FastFoodRestaurantAcceptsReservationsFieldEnum = String;
...
pub struct FastFoodRestaurant {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<FastFoodRestaurantKnowsAboutFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<FastFoodRestaurantImageFieldEnum>,
    ///<https://schema.org/latitude>
    #[serde(rename = "latitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<FastFoodRestaurantLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<FastFoodRestaurantPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<FastFoodRestaurantKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<FastFoodRestaurantAcceptedPaymentMethodFieldEnum>,
    ///<https://schema.org/funder>
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<FastFoodRestaurantFunderFieldEnum>,
    ///<https://schema.org/diversityStaffingReport>
    #[serde(rename = "diversityStaffingReport")]
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<
        FastFoodRestaurantDiversityStaffingReportFieldEnum,
    >,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<FastFoodRestaurantSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<FastFoodRestaurantDiversityPolicyFieldEnum>,
    ///<https://schema.org/additionalType>
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<FastFoodRestaurantAdditionalTypeFieldEnum>,
    ///<https://schema.org/location>
    #[serde(rename = "location")]
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<FastFoodRestaurantLocationFieldEnum>,
    ///<https://schema.org/memberOf>
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<FastFoodRestaurantMemberOfFieldEnum>,
    ...
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<FastFoodRestaurantOwnsFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<FastFoodRestaurantGeoFieldEnum>,
    ///<https://schema.org/geoTouches>
    #[serde(rename = "geoTouches")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<FastFoodRestaurantGeoTouchesFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<FastFoodRestaurantPhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<FastFoodRestaurantGeoCoversFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<FastFoodRestaurantAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<FastFoodRestaurantKnowsLanguageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<FastFoodRestaurantGeoIntersectsFieldEnum>,
    ///<https://schema.org/unnamedSourcesPolicy>
    #[serde(rename = "unnamedSourcesPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<FastFoodRestaurantUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<FastFoodRestaurantServiceAreaFieldEnum>,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<FastFoodRestaurantLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<FastFoodRestaurantIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<FastFoodRestaurantAreaServedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<FastFoodRestaurantGeoOverlapsFieldEnum>,
    ///<https://schema.org/geoDisjoint>
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<FastFoodRestaurantGeoDisjointFieldEnum>,
    ...
    pub actionable_feedback_policy: Vec<
        FastFoodRestaurantActionableFeedbackPolicyFieldEnum,
    >,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<FastFoodRestaurantMainEntityOfPageFieldEnum>,
    ///<https://schema.org/hasMap>
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<FastFoodRestaurantHasMapFieldEnum>,
    ///<https://schema.org/photos>
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<FastFoodRestaurantPhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub has_menu: Vec<FastFoodRestaurantHasMenuFieldEnum>,
    ///<https://schema.org/founder>
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<FastFoodRestaurantFounderFieldEnum>,
    ///<https://schema.org/acceptsReservations>
    #[serde(rename = "acceptsReservations")]
    #[serde_as(as = "OneOrMany<_>")]
    pub accepts_reservations: Vec<FastFoodRestaurantAcceptsReservationsFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<FastFoodRestaurantDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<FastFoodRestaurantGeoEqualsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<FastFoodRestaurantGeoCrossesFieldEnum>,
    ///<https://schema.org/geoWithin>
    #[serde(rename = "geoWithin")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<FastFoodRestaurantGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<FastFoodRestaurantEthicsPolicyFieldEnum>,
    ...
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<FastFoodRestaurantBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<FastFoodRestaurantGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<FastFoodRestaurantMembersFieldEnum>,
    ///<https://schema.org/menu>
    #[serde(rename = "menu")]
    #[serde_as(as = "OneOrMany<_>")]
    pub menu: Vec<FastFoodRestaurantMenuFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<FastFoodRestaurantLongitudeFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<FastFoodRestaurantMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<FastFoodRestaurantSponsorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<FastFoodRestaurantCorrectionsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<FastFoodRestaurantOwnershipFundingInfoFieldEnum>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<FastFoodRestaurantSkillsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<FastFoodRestaurantGeoContainsFieldEnum>,
}
