...
pub type DiagnosticProcedureAdditionalTypeFieldEnum = String;
...
pub struct DiagnosticProcedure {
    ...
    pub status: Vec<DiagnosticProcedureStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<DiagnosticProcedureMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<DiagnosticProcedureDescriptionFieldEnum>,
    ///<https://schema.org/preparation>
    #[serde(rename = "preparation")]
    #[serde_as(as = "OneOrMany<_>")]
    pub preparation: Vec<DiagnosticProcedurePreparationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<DiagnosticProcedureSubjectOfFieldEnum>,
    ///<https://schema.org/additionalType>
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<DiagnosticProcedureAdditionalTypeFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<DiagnosticProcedureLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<DiagnosticProcedureIdentifierFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<DiagnosticProcedureImageFieldEnum>,
