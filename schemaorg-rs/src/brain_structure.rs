...
pub type BrainStructureAdditionalTypeFieldEnum = String;
...
pub struct BrainStructure {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<BrainStructureMainEntityOfPageFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<BrainStructureSubjectOfFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<BrainStructureImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<BrainStructureLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<BrainStructureIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<BrainStructureAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<BrainStructureDescriptionFieldEnum>,
}
