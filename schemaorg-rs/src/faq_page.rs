...
pub type FAQPageFileFormatFieldEnum = String;
///https://schema.org/schemaVersion
///https://schema.org/Text
///https://schema.org/URL
pub type FAQPageSchemaVersionFieldEnum = String;
///https://schema.org/expires
///https://schema.org/Date
///https://schema.org/DateTime
pub type FAQPageExpiresFieldEnum = String;
...
///https://schema.org/Date
///https://schema.org/DateTime
pub type FAQPageDateCreatedFieldEnum = String;
///https://schema.org/genre
///https://schema.org/Text
///https://schema.org/URL
pub type FAQPageGenreFieldEnum = String;
///https://schema.org/dateModified
///https://schema.org/Date
///https://schema.org/DateTime
pub type FAQPageDateModifiedFieldEnum = String;
///https://schema.org/temporalCoverage
///https://schema.org/DateTime
///https://schema.org/Text
///https://schema.org/URL
pub type FAQPageTemporalCoverageFieldEnum = String;
///https://schema.org/editEIDR
///https://schema.org/Text
///https://schema.org/URL
pub type FAQPageEditEIDRFieldEnum = String;
///https://schema.org/temporal
///https://schema.org/DateTime
///https://schema.org/Text
pub type FAQPageTemporalFieldEnum = String;
///https://schema.org/datePublished
///https://schema.org/Date
///https://schema.org/DateTime
pub type FAQPageDatePublishedFieldEnum = String;
///https://schema.org/encodingFormat
///https://schema.org/Text
///https://schema.org/URL
pub type FAQPageEncodingFormatFieldEnum = String;
...
pub struct FAQPage {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub learning_resource_type: Vec<FAQPageLearningResourceTypeFieldEnum>,
    ///https://schema.org/license
    #[serde(rename = "license")]
    #[serde_as(as = "OneOrMany<_>")]
    pub license: Vec<FAQPageLicenseFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub version: Vec<FAQPageVersionFieldEnum>,
    ///https://schema.org/fileFormat
    #[serde(rename = "fileFormat")]
    #[serde_as(as = "OneOrMany<_>")]
    pub file_format: Vec<FAQPageFileFormatFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub schema_version: Vec<FAQPageSchemaVersionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<FAQPageSubjectOfFieldEnum>,
    ///https://schema.org/expires
    #[serde(rename = "expires")]
    #[serde_as(as = "OneOrMany<_>")]
    pub expires: Vec<FAQPageExpiresFieldEnum>,
    ///https://schema.org/additionalType
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<FAQPageAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<FAQPageImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material_extent: Vec<FAQPageMaterialExtentFieldEnum>,
    ///https://schema.org/identifier
    #[serde(rename = "identifier")]
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<FAQPageIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_created: Vec<FAQPageDateCreatedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub breadcrumb: Vec<FAQPageBreadcrumbFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub speakable: Vec<FAQPageSpeakableFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_use: Vec<FAQPageEducationalUseFieldEnum>,
    ///https://schema.org/genre
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    pub genre: Vec<FAQPageGenreFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_modified: Vec<FAQPageDateModifiedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub contributor: Vec<FAQPageContributorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material: Vec<FAQPageMaterialFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub provider: Vec<FAQPageProviderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub creator: Vec<FAQPageCreatorFieldEnum>,
    ///https://schema.org/acquireLicensePage
    #[serde(rename = "acquireLicensePage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub acquire_license_page: Vec<FAQPageAcquireLicensePageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub archived_at: Vec<FAQPageArchivedAtFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub content_rating: Vec<FAQPageContentRatingFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub citation: Vec<FAQPageCitationFieldEnum>,
    ///https://schema.org/temporalCoverage
    #[serde(rename = "temporalCoverage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal_coverage: Vec<FAQPageTemporalCoverageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<FAQPageMainEntityOfPageFieldEnum>,
    ///https://schema.org/position
    #[serde(rename = "position")]
    #[serde_as(as = "OneOrMany<_>")]
    pub position: Vec<FAQPagePositionFieldEnum>,
    ///https://schema.org/inLanguage
    #[serde(rename = "inLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub in_language: Vec<FAQPageInLanguageFieldEnum>,
    ///https://schema.org/editEIDR
    #[serde(rename = "editEIDR")]
    #[serde_as(as = "OneOrMany<_>")]
    pub edit_eidr: Vec<FAQPageEditEIDRFieldEnum>,
    ///https://schema.org/maintainer
    #[serde(rename = "maintainer")]
    #[serde_as(as = "OneOrMany<_>")]
    pub maintainer: Vec<FAQPageMaintainerFieldEnum>,
    ///https://schema.org/isBasedOn
    #[serde(rename = "isBasedOn")]
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on: Vec<FAQPageIsBasedOnFieldEnum>,
    ///https://schema.org/creativeWorkStatus
    #[serde(rename = "creativeWorkStatus")]
    #[serde_as(as = "OneOrMany<_>")]
    pub creative_work_status: Vec<FAQPageCreativeWorkStatusFieldEnum>,
    ///https://schema.org/assesses
    #[serde(rename = "assesses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub assesses: Vec<FAQPageAssessesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<FAQPagePublishingPrinciplesFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub producer: Vec<FAQPageProducerFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal: Vec<FAQPageTemporalFieldEnum>,
    ///https://schema.org/publisher
    #[serde(rename = "publisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publisher: Vec<FAQPagePublisherFieldEnum>,
    ///https://schema.org/pattern
    #[serde(rename = "pattern")]
    #[serde_as(as = "OneOrMany<_>")]
    pub pattern: Vec<FAQPagePatternFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on_url: Vec<FAQPageIsBasedOnUrlFieldEnum>,
    ///https://schema.org/keywords
    #[serde(rename = "keywords")]
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<FAQPageKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub translator: Vec<FAQPageTranslatorFieldEnum>,
    ///https://schema.org/sponsor
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<FAQPageSponsorFieldEnum>,
    ...
    #[serde(rename = "offers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub offers: Vec<FAQPageOffersFieldEnum>,
    ///https://schema.org/usageInfo
    #[serde(rename = "usageInfo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub usage_info: Vec<FAQPageUsageInfoFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<FAQPageFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_published: Vec<FAQPageDatePublishedFieldEnum>,
    ...
    #[serde(rename = "size")]
    #[serde_as(as = "OneOrMany<_>")]
    pub size: Vec<FAQPageSizeFieldEnum>,
    ///https://schema.org/educationalLevel
    #[serde(rename = "educationalLevel")]
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_level: Vec<FAQPageEducationalLevelFieldEnum>,
    ///https://schema.org/sdLicense
    #[serde(rename = "sdLicense")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_license: Vec<FAQPageSdLicenseFieldEnum>,
    ///https://schema.org/author
    #[serde(rename = "author")]
    #[serde_as(as = "OneOrMany<_>")]
    pub author: Vec<FAQPageAuthorFieldEnum>,
    ///https://schema.org/sdPublisher
    #[serde(rename = "sdPublisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_publisher: Vec<FAQPageSdPublisherFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub encoding_format: Vec<FAQPageEncodingFormatFieldEnum>,
    ...
    #[serde(rename = "video")]
    #[serde_as(as = "OneOrMany<_>")]
    pub video: Vec<FAQPageVideoFieldEnum>,
    ///https://schema.org/copyrightHolder
    #[serde(rename = "copyrightHolder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub copyright_holder: Vec<FAQPageCopyrightHolderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub teaches: Vec<FAQPageTeachesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub reviewed_by: Vec<FAQPageReviewedByFieldEnum>,
    ...
    #[serde(rename = "audio")]
    #[serde_as(as = "OneOrMany<_>")]
    pub audio: Vec<FAQPageAudioFieldEnum>,
    ///https://schema.org/correction
    #[serde(rename = "correction")]
    #[serde_as(as = "OneOrMany<_>")]
    pub correction: Vec<FAQPageCorrectionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<FAQPageDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_part_of: Vec<FAQPageIsPartOfFieldEnum>,
