...
pub type StadiumOrArenaAdditionalTypeFieldEnum = String;
...
pub struct StadiumOrArena {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<StadiumOrArenaPublishingPrinciplesFieldEnum>,
    ///https://schema.org/brand
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<StadiumOrArenaBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<StadiumOrArenaKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<StadiumOrArenaAcceptedPaymentMethodFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<StadiumOrArenaIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<StadiumOrArenaAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<StadiumOrArenaGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<StadiumOrArenaEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<StadiumOrArenaLongitudeFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<StadiumOrArenaSubjectOfFieldEnum>,
    ///https://schema.org/founder
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<StadiumOrArenaFounderFieldEnum>,
    ///https://schema.org/photos
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<StadiumOrArenaPhotosFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<StadiumOrArenaMemberFieldEnum>,
    ///https://schema.org/funder
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<StadiumOrArenaFunderFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<StadiumOrArenaHasMapFieldEnum>,
    ///https://schema.org/unnamedSourcesPolicy
    #[serde(rename = "unnamedSourcesPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<StadiumOrArenaUnnamedSourcesPolicyFieldEnum>,
    ///https://schema.org/skills
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<StadiumOrArenaSkillsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<StadiumOrArenaMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<StadiumOrArenaGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<StadiumOrArenaCorrectionsPolicyFieldEnum>,
    ///https://schema.org/geoTouches
    #[serde(rename = "geoTouches")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<StadiumOrArenaGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<StadiumOrArenaGeoOverlapsFieldEnum>,
    ///https://schema.org/diversityStaffingReport
    #[serde(rename = "diversityStaffingReport")]
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<StadiumOrArenaDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<StadiumOrArenaSponsorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<StadiumOrArenaDiversityPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<StadiumOrArenaServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<StadiumOrArenaLocationFieldEnum>,
    ///https://schema.org/logo
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<StadiumOrArenaLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<StadiumOrArenaAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<StadiumOrArenaKnowsLanguageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<StadiumOrArenaActionableFeedbackPolicyFieldEnum>,
    ///https://schema.org/photo
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<StadiumOrArenaPhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<StadiumOrArenaGeoContainsFieldEnum>,
    ///https://schema.org/mainEntityOfPage
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<StadiumOrArenaMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<StadiumOrArenaGeoEqualsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<StadiumOrArenaLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<StadiumOrArenaGeoIntersectsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<StadiumOrArenaGeoCrossesFieldEnum>,
    ///https://schema.org/geoCovers
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<StadiumOrArenaGeoCoversFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<StadiumOrArenaKeywordsFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<StadiumOrArenaImageFieldEnum>,
    ...
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<StadiumOrArenaOwnsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<StadiumOrArenaOwnershipFundingInfoFieldEnum>,
    ///https://schema.org/memberOf
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<StadiumOrArenaMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<StadiumOrArenaGeoDisjointFieldEnum>,
    ...
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<StadiumOrArenaGeoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<StadiumOrArenaAreaServedFieldEnum>,
    ///https://schema.org/description
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<StadiumOrArenaDescriptionFieldEnum>,
}
