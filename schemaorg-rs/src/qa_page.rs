...
pub type QAPageDateCreatedFieldEnum = String;
///https://schema.org/schemaVersion
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageSchemaVersionFieldEnum = String;
///https://schema.org/editEIDR
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageEditEIDRFieldEnum = String;
///https://schema.org/dateModified
///https://schema.org/Date
///https://schema.org/DateTime
pub type QAPageDateModifiedFieldEnum = String;
///https://schema.org/temporal
///https://schema.org/DateTime
///https://schema.org/Text
pub type QAPageTemporalFieldEnum = String;
///https://schema.org/genre
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageGenreFieldEnum = String;
///https://schema.org/additionalType
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageAdditionalTypeFieldEnum = String;
///https://schema.org/expires
///https://schema.org/Date
///https://schema.org/DateTime
pub type QAPageExpiresFieldEnum = String;
///https://schema.org/fileFormat
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageFileFormatFieldEnum = String;
///https://schema.org/datePublished
///https://schema.org/Date
///https://schema.org/DateTime
pub type QAPageDatePublishedFieldEnum = String;
///https://schema.org/temporalCoverage
///https://schema.org/DateTime
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageTemporalCoverageFieldEnum = String;
///https://schema.org/encodingFormat
///https://schema.org/Text
///https://schema.org/URL
pub type QAPageEncodingFormatFieldEnum = String;
...
pub struct QAPage {
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<QAPageFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<QAPageKeywordsFieldEnum>,
    ///https://schema.org/dateCreated
    #[serde(rename = "dateCreated")]
    #[serde_as(as = "OneOrMany<_>")]
    pub date_created: Vec<QAPageDateCreatedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub schema_version: Vec<QAPageSchemaVersionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<QAPageIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material: Vec<QAPageMaterialFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_level: Vec<QAPageEducationalLevelFieldEnum>,
    ///https://schema.org/producer
    #[serde(rename = "producer")]
    #[serde_as(as = "OneOrMany<_>")]
    pub producer: Vec<QAPageProducerFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_publisher: Vec<QAPageSdPublisherFieldEnum>,
    ///https://schema.org/mainEntityOfPage
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<QAPageMainEntityOfPageFieldEnum>,
    ///https://schema.org/position
    #[serde(rename = "position")]
    #[serde_as(as = "OneOrMany<_>")]
    pub position: Vec<QAPagePositionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_use: Vec<QAPageEducationalUseFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_license: Vec<QAPageSdLicenseFieldEnum>,
    ///https://schema.org/pattern
    #[serde(rename = "pattern")]
    #[serde_as(as = "OneOrMany<_>")]
    pub pattern: Vec<QAPagePatternFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub license: Vec<QAPageLicenseFieldEnum>,
    ///https://schema.org/author
    #[serde(rename = "author")]
    #[serde_as(as = "OneOrMany<_>")]
    pub author: Vec<QAPageAuthorFieldEnum>,
    ///https://schema.org/creativeWorkStatus
    #[serde(rename = "creativeWorkStatus")]
    #[serde_as(as = "OneOrMany<_>")]
    pub creative_work_status: Vec<QAPageCreativeWorkStatusFieldEnum>,
    ///https://schema.org/learningResourceType
    #[serde(rename = "learningResourceType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub learning_resource_type: Vec<QAPageLearningResourceTypeFieldEnum>,
    ///https://schema.org/translator
    #[serde(rename = "translator")]
    #[serde_as(as = "OneOrMany<_>")]
    pub translator: Vec<QAPageTranslatorFieldEnum>,
    ///https://schema.org/description
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<QAPageDescriptionFieldEnum>,
    ///https://schema.org/usageInfo
    #[serde(rename = "usageInfo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub usage_info: Vec<QAPageUsageInfoFieldEnum>,
    ///https://schema.org/editEIDR
    #[serde(rename = "editEIDR")]
    #[serde_as(as = "OneOrMany<_>")]
    pub edit_eidr: Vec<QAPageEditEIDRFieldEnum>,
    ///https://schema.org/dateModified
    #[serde(rename = "dateModified")]
    #[serde_as(as = "OneOrMany<_>")]
    pub date_modified: Vec<QAPageDateModifiedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal: Vec<QAPageTemporalFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<QAPageImageFieldEnum>,
    ...
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    pub genre: Vec<QAPageGenreFieldEnum>,
    ///https://schema.org/reviewedBy
    #[serde(rename = "reviewedBy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub reviewed_by: Vec<QAPageReviewedByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<QAPageAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "video")]
    #[serde_as(as = "OneOrMany<_>")]
    pub video: Vec<QAPageVideoFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<QAPageSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub contributor: Vec<QAPageContributorFieldEnum>,
    ...
    #[serde(rename = "audio")]
    #[serde_as(as = "OneOrMany<_>")]
    pub audio: Vec<QAPageAudioFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub content_rating: Vec<QAPageContentRatingFieldEnum>,
    ///https://schema.org/isPartOf
    #[serde(rename = "isPartOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub is_part_of: Vec<QAPageIsPartOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub assesses: Vec<QAPageAssessesFieldEnum>,
    ///https://schema.org/sponsor
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<QAPageSponsorFieldEnum>,
    ///https://schema.org/version
    #[serde(rename = "version")]
    #[serde_as(as = "OneOrMany<_>")]
    pub version: Vec<QAPageVersionFieldEnum>,
    ///https://schema.org/archivedAt
    #[serde(rename = "archivedAt")]
    #[serde_as(as = "OneOrMany<_>")]
    pub archived_at: Vec<QAPageArchivedAtFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub speakable: Vec<QAPageSpeakableFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub citation: Vec<QAPageCitationFieldEnum>,
    ///https://schema.org/acquireLicensePage
    #[serde(rename = "acquireLicensePage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub acquire_license_page: Vec<QAPageAcquireLicensePageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub correction: Vec<QAPageCorrectionFieldEnum>,
    ...
    #[serde(rename = "size")]
    #[serde_as(as = "OneOrMany<_>")]
    pub size: Vec<QAPageSizeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub expires: Vec<QAPageExpiresFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on_url: Vec<QAPageIsBasedOnUrlFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub file_format: Vec<QAPageFileFormatFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publisher: Vec<QAPagePublisherFieldEnum>,
    ...
    #[serde(rename = "offers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub offers: Vec<QAPageOffersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub breadcrumb: Vec<QAPageBreadcrumbFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub in_language: Vec<QAPageInLanguageFieldEnum>,
    ///https://schema.org/isBasedOn
    #[serde(rename = "isBasedOn")]
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on: Vec<QAPageIsBasedOnFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_published: Vec<QAPageDatePublishedFieldEnum>,
    ///https://schema.org/publishingPrinciples
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<QAPagePublishingPrinciplesFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub copyright_holder: Vec<QAPageCopyrightHolderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material_extent: Vec<QAPageMaterialExtentFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub provider: Vec<QAPageProviderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal_coverage: Vec<QAPageTemporalCoverageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub creator: Vec<QAPageCreatorFieldEnum>,
    ///https://schema.org/encodingFormat
    #[serde(rename = "encodingFormat")]
    #[serde_as(as = "OneOrMany<_>")]
    pub encoding_format: Vec<QAPageEncodingFormatFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub teaches: Vec<QAPageTeachesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub maintainer: Vec<QAPageMaintainerFieldEnum>,
