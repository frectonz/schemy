...
pub type DoseScheduleAdditionalTypeFieldEnum = String;
...
pub struct DoseSchedule {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub dose_value: Vec<DoseScheduleDoseValueFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub legal_status: Vec<DoseScheduleLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub main_entity_of_page: Vec<DoseScheduleMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub identifier: Vec<DoseScheduleIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub description: Vec<DoseScheduleDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub subject_of: Vec<DoseScheduleSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub additional_type: Vec<DoseScheduleAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub image: Vec<DoseScheduleImageFieldEnum>,
}
