...
pub type IndividualPhysicianAdditionalTypeFieldEnum = String;
///https://schema.org/IndividualPhysician
#[serde_as]
#[derive(Debug, serde::Deserialize)]
#[cfg_attr(feature = "uniffi", derive(uniffi::Record))]
pub struct IndividualPhysician {
    #[serde(rename = "@context")]
    pub context: String,
    ///https://schema.org/geoIntersects
    #[serde(rename = "geoIntersects")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<IndividualPhysicianGeoIntersectsFieldEnum>,
    ///https://schema.org/serviceArea
    #[serde(rename = "serviceArea")]
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<IndividualPhysicianServiceAreaFieldEnum>,
    ...
    pub actionable_feedback_policy: Vec<
        IndividualPhysicianActionableFeedbackPolicyFieldEnum,
    >,
    ///https://schema.org/members
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<IndividualPhysicianMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<IndividualPhysicianLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<IndividualPhysicianEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<IndividualPhysicianAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<IndividualPhysicianDescriptionFieldEnum>,
    ...
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<IndividualPhysicianGeoFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<IndividualPhysicianImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<IndividualPhysicianMainEntityOfPageFieldEnum>,
    ///https://schema.org/practicesAt
    #[serde(rename = "practicesAt")]
    #[serde_as(as = "OneOrMany<_>")]
    pub practices_at: Vec<MedicalOrganization>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<IndividualPhysicianCorrectionsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<IndividualPhysicianOwnershipFundingInfoFieldEnum>,
    ///https://schema.org/geoDisjoint
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<IndividualPhysicianGeoDisjointFieldEnum>,
    ///https://schema.org/geoEquals
    #[serde(rename = "geoEquals")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<IndividualPhysicianGeoEqualsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<IndividualPhysicianIdentifierFieldEnum>,
    ///https://schema.org/geoCovers
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<IndividualPhysicianGeoCoversFieldEnum>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<IndividualPhysicianSkillsFieldEnum>,
    ///https://schema.org/geoContains
    #[serde(rename = "geoContains")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<IndividualPhysicianGeoContainsFieldEnum>,
    ///https://schema.org/hasMap
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<IndividualPhysicianHasMapFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<IndividualPhysicianGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<IndividualPhysicianAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<IndividualPhysicianGeoCrossesFieldEnum>,
    ///https://schema.org/memberOf
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<IndividualPhysicianMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub occupational_category: Vec<IndividualPhysicianOccupationalCategoryFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<IndividualPhysicianGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<IndividualPhysicianLongitudeFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<IndividualPhysicianFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<IndividualPhysicianKnowsLanguageFieldEnum>,
    ///https://schema.org/brand
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<IndividualPhysicianBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<IndividualPhysicianPublishingPrinciplesFieldEnum>,
    ///https://schema.org/keywords
    #[serde(rename = "keywords")]
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<IndividualPhysicianKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<IndividualPhysicianSponsorFieldEnum>,
    ///https://schema.org/logo
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<IndividualPhysicianLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<IndividualPhysicianAreaServedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<IndividualPhysicianAcceptedPaymentMethodFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<IndividualPhysicianGeoOverlapsFieldEnum>,
    ///https://schema.org/member
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<IndividualPhysicianMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub available_service: Vec<IndividualPhysicianAvailableServiceFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<IndividualPhysicianPhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<IndividualPhysicianGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<IndividualPhysicianSubjectOfFieldEnum>,
    ...
    pub diversity_staffing_report: Vec<
        IndividualPhysicianDiversityStaffingReportFieldEnum,
    >,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<IndividualPhysicianKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<IndividualPhysicianUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<IndividualPhysicianDiversityPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<IndividualPhysicianFounderFieldEnum>,
    ///https://schema.org/photos
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<IndividualPhysicianPhotosFieldEnum>,
    ///https://schema.org/location
    #[serde(rename = "location")]
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<IndividualPhysicianLocationFieldEnum>,
    ///https://schema.org/owns
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<IndividualPhysicianOwnsFieldEnum>,
