...
pub type ToyStoreAdditionalTypeFieldEnum = String;
...
pub struct ToyStore {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<ToyStoreUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<ToyStoreSkillsFieldEnum>,
    ///<https://schema.org/publishingPrinciples>
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<ToyStorePublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<ToyStoreKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<ToyStoreOwnershipFundingInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<ToyStoreServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<ToyStoreKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<ToyStoreLocationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<ToyStoreDiversityPolicyFieldEnum>,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<ToyStoreLogoFieldEnum>,
    ...
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<ToyStoreOwnsFieldEnum>,
    ...
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<ToyStoreBrandFieldEnum>,
    ///<https://schema.org/knowsLanguage>
    #[serde(rename = "knowsLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<ToyStoreKnowsLanguageFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<ToyStoreFunderFieldEnum>,
    ///<https://schema.org/address>
    #[serde(rename = "address")]
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<ToyStoreAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<ToyStoreCorrectionsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<ToyStoreSponsorFieldEnum>,
    ///<https://schema.org/memberOf>
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<ToyStoreMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<ToyStoreDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<ToyStoreEthicsPolicyFieldEnum>,
    ///<https://schema.org/actionableFeedbackPolicy>
    #[serde(rename = "actionableFeedbackPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<ToyStoreActionableFeedbackPolicyFieldEnum>,
    ///<https://schema.org/areaServed>
    #[serde(rename = "areaServed")]
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<ToyStoreAreaServedFieldEnum>,
    ///<https://schema.org/members>
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<ToyStoreMembersFieldEnum>,
    ///<https://schema.org/member>
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<ToyStoreMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<ToyStoreAcceptedPaymentMethodFieldEnum>,
    ///<https://schema.org/founder>
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<ToyStoreFounderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<ToyStoreMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<ToyStoreIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<ToyStoreDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<ToyStoreSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<ToyStoreAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<ToyStoreImageFieldEnum>,
    ///<https://schema.org/photos>
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<ToyStorePhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<ToyStoreGeoIntersectsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<ToyStoreGeoOverlapsFieldEnum>,
    ///<https://schema.org/geoCrosses>
    #[serde(rename = "geoCrosses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<ToyStoreGeoCrossesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<ToyStoreGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<ToyStoreGeoContainsFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<ToyStoreGeoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<ToyStoreLatitudeFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<ToyStoreHasMapFieldEnum>,
    ///<https://schema.org/geoTouches>
    #[serde(rename = "geoTouches")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<ToyStoreGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<ToyStoreGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<ToyStoreLongitudeFieldEnum>,
    ///<https://schema.org/geoDisjoint>
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<ToyStoreGeoDisjointFieldEnum>,
    ///<https://schema.org/geoCovers>
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<ToyStoreGeoCoversFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<ToyStorePhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<ToyStoreGeoEqualsFieldEnum>,
}
