...
pub type WineryAcceptsReservationsFieldEnum = String;
///<https://schema.org/additionalType>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type WineryAdditionalTypeFieldEnum = String;
...
pub struct Winery {
    ...
    pub main_entity_of_page: Vec<WineryMainEntityOfPageFieldEnum>,
    ...
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<WineryOwnsFieldEnum>,
    ///<https://schema.org/acceptedPaymentMethod>
    #[serde(rename = "acceptedPaymentMethod")]
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<WineryAcceptedPaymentMethodFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<WineryCorrectionsPolicyFieldEnum>,
    ///<https://schema.org/member>
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<WineryMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub has_menu: Vec<WineryHasMenuFieldEnum>,
    ///<https://schema.org/photo>
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<WineryPhotoFieldEnum>,
    ///<https://schema.org/ethicsPolicy>
    #[serde(rename = "ethicsPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<WineryEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<WineryGeoContainsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<WineryGeoIntersectsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<WineryActionableFeedbackPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<WineryGeoCoveredByFieldEnum>,
    ///<https://schema.org/geoWithin>
    #[serde(rename = "geoWithin")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<WineryGeoWithinFieldEnum>,
    ///<https://schema.org/diversityPolicy>
    #[serde(rename = "diversityPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<WineryDiversityPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<WineryGeoDisjointFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<WineryServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<WineryKeywordsFieldEnum>,
    ///<https://schema.org/brand>
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<WineryBrandFieldEnum>,
    ///<https://schema.org/members>
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<WineryMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<WineryGeoCoversFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<WineryAddressFieldEnum>,
    ...
    #[serde(rename = "menu")]
    #[serde_as(as = "OneOrMany<_>")]
    pub menu: Vec<WineryMenuFieldEnum>,
    ///<https://schema.org/ownershipFundingInfo>
    #[serde(rename = "ownershipFundingInfo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<WineryOwnershipFundingInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<WineryFounderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<WineryGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepts_reservations: Vec<WineryAcceptsReservationsFieldEnum>,
    ///<https://schema.org/longitude>
    #[serde(rename = "longitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<WineryLongitudeFieldEnum>,
    ...
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<WineryPhotosFieldEnum>,
    ///<https://schema.org/funder>
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<WineryFunderFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<WinerySubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<WineryKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<WineryDescriptionFieldEnum>,
    ///<https://schema.org/knowsLanguage>
    #[serde(rename = "knowsLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<WineryKnowsLanguageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<WineryLocationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<WineryUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<WineryGeoCrossesFieldEnum>,
    ///<https://schema.org/diversityStaffingReport>
    #[serde(rename = "diversityStaffingReport")]
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<WineryDiversityStaffingReportFieldEnum>,
    ///<https://schema.org/latitude>
    #[serde(rename = "latitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<WineryLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<WineryGeoEqualsFieldEnum>,
    ///<https://schema.org/memberOf>
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<WineryMemberOfFieldEnum>,
    ///<https://schema.org/publishingPrinciples>
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<WineryPublishingPrinciplesFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<WineryGeoFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<WineryHasMapFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<WineryAreaServedFieldEnum>,
    ///<https://schema.org/sponsor>
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<WinerySponsorFieldEnum>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<WinerySkillsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<WineryGeoOverlapsFieldEnum>,
    ///<https://schema.org/image>
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<WineryImageFieldEnum>,
    ///<https://schema.org/logo>
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<WineryLogoFieldEnum>,
    ///<https://schema.org/additionalType>
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<WineryAdditionalTypeFieldEnum>,
    ///<https://schema.org/identifier>
    #[serde(rename = "identifier")]
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<WineryIdentifierFieldEnum>,
