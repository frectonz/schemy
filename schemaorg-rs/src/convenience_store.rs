...
pub type ConvenienceStoreAdditionalTypeFieldEnum = String;
...
pub struct ConvenienceStore {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<ConvenienceStoreDiversityPolicyFieldEnum>,
    ///https://schema.org/actionableFeedbackPolicy
    #[serde(rename = "actionableFeedbackPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<
        ConvenienceStoreActionableFeedbackPolicyFieldEnum,
    >,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<ConvenienceStoreLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<ConvenienceStoreEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<ConvenienceStoreSubjectOfFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<ConvenienceStoreHasMapFieldEnum>,
    ///https://schema.org/serviceArea
    #[serde(rename = "serviceArea")]
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<ConvenienceStoreServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<ConvenienceStoreOwnershipFundingInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<ConvenienceStoreGeoCrossesFieldEnum>,
    ///https://schema.org/geoIntersects
    #[serde(rename = "geoIntersects")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<ConvenienceStoreGeoIntersectsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<ConvenienceStoreLatitudeFieldEnum>,
    ///https://schema.org/geo
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<ConvenienceStoreGeoFieldEnum>,
    ///https://schema.org/correctionsPolicy
    #[serde(rename = "correctionsPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<ConvenienceStoreCorrectionsPolicyFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<ConvenienceStoreMemberFieldEnum>,
    ///https://schema.org/unnamedSourcesPolicy
    #[serde(rename = "unnamedSourcesPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<ConvenienceStoreUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<ConvenienceStoreKnowsAboutFieldEnum>,
    ///https://schema.org/skills
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<ConvenienceStoreSkillsFieldEnum>,
    ///https://schema.org/funder
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<ConvenienceStoreFunderFieldEnum>,
    ///https://schema.org/sponsor
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<ConvenienceStoreSponsorFieldEnum>,
    ///https://schema.org/knowsLanguage
    #[serde(rename = "knowsLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<ConvenienceStoreKnowsLanguageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<ConvenienceStoreDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<ConvenienceStoreAreaServedFieldEnum>,
    ///https://schema.org/acceptedPaymentMethod
    #[serde(rename = "acceptedPaymentMethod")]
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<ConvenienceStoreAcceptedPaymentMethodFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<ConvenienceStoreMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<ConvenienceStoreKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<ConvenienceStoreGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<ConvenienceStoreGeoOverlapsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<ConvenienceStoreLongitudeFieldEnum>,
    ///https://schema.org/publishingPrinciples
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<ConvenienceStorePublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<ConvenienceStoreDiversityStaffingReportFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<ConvenienceStoreImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<ConvenienceStoreLocationFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<ConvenienceStorePhotoFieldEnum>,
    ///https://schema.org/founder
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<ConvenienceStoreFounderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<ConvenienceStoreMainEntityOfPageFieldEnum>,
    ///https://schema.org/geoWithin
    #[serde(rename = "geoWithin")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<ConvenienceStoreGeoWithinFieldEnum>,
    ///https://schema.org/owns
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<ConvenienceStoreOwnsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<ConvenienceStoreGeoContainsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<ConvenienceStoreAdditionalTypeFieldEnum>,
    ///https://schema.org/brand
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<ConvenienceStoreBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<ConvenienceStoreGeoDisjointFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<ConvenienceStoreGeoCoversFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<ConvenienceStoreAddressFieldEnum>,
    ///https://schema.org/geoCoveredBy
    #[serde(rename = "geoCoveredBy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<ConvenienceStoreGeoCoveredByFieldEnum>,
    ///https://schema.org/geoEquals
    #[serde(rename = "geoEquals")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<ConvenienceStoreGeoEqualsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<ConvenienceStoreIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<ConvenienceStoreMemberOfFieldEnum>,
    ///https://schema.org/photos
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<ConvenienceStorePhotosFieldEnum>,
