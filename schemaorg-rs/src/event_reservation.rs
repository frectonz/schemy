...
pub type EventReservationAdditionalTypeFieldEnum = String;
...
pub struct EventReservation {
    ...
    pub provider: Vec<EventReservationProviderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub total_price: Vec<EventReservationTotalPriceFieldEnum>,
    ///<https://schema.org/broker>
    #[serde(rename = "broker")]
    #[serde_as(as = "OneOrMany<_>")]
    pub broker: Vec<EventReservationBrokerFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub booking_agent: Vec<EventReservationBookingAgentFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub under_name: Vec<EventReservationUnderNameFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<EventReservationMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<EventReservationIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<EventReservationDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<EventReservationSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<EventReservationAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<EventReservationImageFieldEnum>,
}
