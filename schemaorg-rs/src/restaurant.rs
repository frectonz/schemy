...
///https://schema.org/Text
///https://schema.org/URL
pub type RestaurantAcceptsReservationsFieldEnum = String;
...
pub struct Restaurant {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<RestaurantKnowsAboutFieldEnum>,
    ///https://schema.org/longitude
    #[serde(rename = "longitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<RestaurantLongitudeFieldEnum>,
    ///https://schema.org/geoWithin
    #[serde(rename = "geoWithin")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<RestaurantGeoWithinFieldEnum>,
    ///https://schema.org/correctionsPolicy
    #[serde(rename = "correctionsPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<RestaurantCorrectionsPolicyFieldEnum>,
    ///https://schema.org/memberOf
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<RestaurantMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<RestaurantActionableFeedbackPolicyFieldEnum>,
    ///https://schema.org/geoEquals
    #[serde(rename = "geoEquals")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<RestaurantGeoEqualsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<RestaurantGeoIntersectsFieldEnum>,
    ///https://schema.org/logo
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<RestaurantLogoFieldEnum>,
    ///https://schema.org/photos
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<RestaurantPhotosFieldEnum>,
    ///https://schema.org/publishingPrinciples
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<RestaurantPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<RestaurantLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<RestaurantDescriptionFieldEnum>,
    ///https://schema.org/ownershipFundingInfo
    #[serde(rename = "ownershipFundingInfo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<RestaurantOwnershipFundingInfoFieldEnum>,
    ///https://schema.org/additionalType
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<RestaurantAdditionalTypeFieldEnum>,
    ///https://schema.org/geoDisjoint
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<RestaurantGeoDisjointFieldEnum>,
    ...
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<RestaurantBrandFieldEnum>,
    ///https://schema.org/sponsor
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<RestaurantSponsorFieldEnum>,
    ///https://schema.org/owns
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<RestaurantOwnsFieldEnum>,
    ///https://schema.org/menu
    #[serde(rename = "menu")]
    #[serde_as(as = "OneOrMany<_>")]
    pub menu: Vec<RestaurantMenuFieldEnum>,
    ///https://schema.org/geoCovers
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<RestaurantGeoCoversFieldEnum>,
    ///https://schema.org/mainEntityOfPage
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<RestaurantMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<RestaurantLocationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<RestaurantEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<RestaurantIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<RestaurantAcceptedPaymentMethodFieldEnum>,
    ///https://schema.org/geoCrosses
    #[serde(rename = "geoCrosses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<RestaurantGeoCrossesFieldEnum>,
    ///https://schema.org/geo
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<RestaurantGeoFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<RestaurantHasMapFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<RestaurantFunderFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<RestaurantMemberFieldEnum>,
    ///https://schema.org/keywords
    #[serde(rename = "keywords")]
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<RestaurantKeywordsFieldEnum>,
    ///https://schema.org/acceptsReservations
    #[serde(rename = "acceptsReservations")]
    #[serde_as(as = "OneOrMany<_>")]
    pub accepts_reservations: Vec<RestaurantAcceptsReservationsFieldEnum>,
    ///https://schema.org/unnamedSourcesPolicy
    #[serde(rename = "unnamedSourcesPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<RestaurantUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<RestaurantDiversityPolicyFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<RestaurantImageFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<RestaurantPhotoFieldEnum>,
    ///https://schema.org/serviceArea
    #[serde(rename = "serviceArea")]
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<RestaurantServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<RestaurantGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<RestaurantDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<RestaurantKnowsLanguageFieldEnum>,
    ///https://schema.org/skills
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<RestaurantSkillsFieldEnum>,
    ///https://schema.org/geoContains
    #[serde(rename = "geoContains")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<RestaurantGeoContainsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<RestaurantGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<RestaurantAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<RestaurantFounderFieldEnum>,
    ///https://schema.org/members
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<RestaurantMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<RestaurantGeoOverlapsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<RestaurantAreaServedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub has_menu: Vec<RestaurantHasMenuFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<RestaurantSubjectOfFieldEnum>,
