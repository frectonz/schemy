...
pub type MedicalConditionAdditionalTypeFieldEnum = String;
...
pub struct MedicalCondition {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<MedicalConditionMainEntityOfPageFieldEnum>,
    ///https://schema.org/legalStatus
    #[serde(rename = "legalStatus")]
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<MedicalConditionLegalStatusFieldEnum>,
    ...
    #[serde(rename = "status")]
    #[serde_as(as = "OneOrMany<_>")]
    pub status: Vec<MedicalConditionStatusFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<MedicalConditionImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<MedicalConditionSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<MedicalConditionAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<MedicalConditionDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<MedicalConditionIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub associated_anatomy: Vec<MedicalConditionAssociatedAnatomyFieldEnum>,
