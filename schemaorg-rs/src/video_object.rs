...
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type VideoObjectEditEIDRFieldEnum = String;
...
///<https://schema.org/DateTime>
///<https://schema.org/Text>
pub type VideoObjectTemporalFieldEnum = String;
...
///<https://schema.org/Date>
///<https://schema.org/DateTime>
pub type VideoObjectExpiresFieldEnum = String;
///<https://schema.org/temporalCoverage>
///<https://schema.org/DateTime>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type VideoObjectTemporalCoverageFieldEnum = String;
///<https://schema.org/schemaVersion>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type VideoObjectSchemaVersionFieldEnum = String;
...
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type VideoObjectAdditionalTypeFieldEnum = String;
...
pub struct VideoObject {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub music_by: Vec<VideoObjectMusicByFieldEnum>,
    ...
    #[serde(rename = "actor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub actor: Vec<VideoObjectActorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub requires_subscription: Vec<VideoObjectRequiresSubscriptionFieldEnum>,
    ///<https://schema.org/encodingFormat>
    ...
    #[serde(rename = "width")]
    #[serde_as(as = "OneOrMany<_>")]
    pub width: Vec<VideoObjectWidthFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ineligible_region: Vec<VideoObjectIneligibleRegionFieldEnum>,
    ...
    #[serde(rename = "height")]
    #[serde_as(as = "OneOrMany<_>")]
    pub height: Vec<VideoObjectHeightFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub provider: Vec<VideoObjectProviderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub citation: Vec<VideoObjectCitationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<VideoObjectPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub usage_info: Vec<VideoObjectUsageInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_license: Vec<VideoObjectSdLicenseFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub license: Vec<VideoObjectLicenseFieldEnum>,
    ///<https://schema.org/maintainer>
    #[serde(rename = "maintainer")]
    #[serde_as(as = "OneOrMany<_>")]
    pub maintainer: Vec<VideoObjectMaintainerFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub pattern: Vec<VideoObjectPatternFieldEnum>,
    ///<https://schema.org/offers>
    #[serde(rename = "offers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub offers: Vec<VideoObjectOffersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub edit_eidr: Vec<VideoObjectEditEIDRFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_level: Vec<VideoObjectEducationalLevelFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material_extent: Vec<VideoObjectMaterialExtentFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub learning_resource_type: Vec<VideoObjectLearningResourceTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal: Vec<VideoObjectTemporalFieldEnum>,
    ///<https://schema.org/isBasedOnUrl>
    #[serde(rename = "isBasedOnUrl")]
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on_url: Vec<VideoObjectIsBasedOnUrlFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub teaches: Vec<VideoObjectTeachesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_part_of: Vec<VideoObjectIsPartOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub creative_work_status: Vec<VideoObjectCreativeWorkStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_use: Vec<VideoObjectEducationalUseFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub version: Vec<VideoObjectVersionFieldEnum>,
    ///<https://schema.org/expires>
    #[serde(rename = "expires")]
    #[serde_as(as = "OneOrMany<_>")]
    pub expires: Vec<VideoObjectExpiresFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub producer: Vec<VideoObjectProducerFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub copyright_holder: Vec<VideoObjectCopyrightHolderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material: Vec<VideoObjectMaterialFieldEnum>,
    ///<https://schema.org/translator>
    #[serde(rename = "translator")]
    #[serde_as(as = "OneOrMany<_>")]
    pub translator: Vec<VideoObjectTranslatorFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<VideoObjectFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub contributor: Vec<VideoObjectContributorFieldEnum>,
    ///<https://schema.org/position>
    #[serde(rename = "position")]
    #[serde_as(as = "OneOrMany<_>")]
    pub position: Vec<VideoObjectPositionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal_coverage: Vec<VideoObjectTemporalCoverageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub schema_version: Vec<VideoObjectSchemaVersionFieldEnum>,
    ///<https://schema.org/acquireLicensePage>
    #[serde(rename = "acquireLicensePage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub acquire_license_page: Vec<VideoObjectAcquireLicensePageFieldEnum>,
    ///<https://schema.org/sponsor>
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<VideoObjectSponsorFieldEnum>,
    ///<https://schema.org/publisher>
    #[serde(rename = "publisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publisher: Vec<VideoObjectPublisherFieldEnum>,
    ///<https://schema.org/assesses>
    #[serde(rename = "assesses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub assesses: Vec<VideoObjectAssessesFieldEnum>,
    ...
    #[serde(rename = "size")]
    #[serde_as(as = "OneOrMany<_>")]
    pub size: Vec<VideoObjectSizeFieldEnum>,
    ///<https://schema.org/contentRating>
    #[serde(rename = "contentRating")]
    #[serde_as(as = "OneOrMany<_>")]
    pub content_rating: Vec<VideoObjectContentRatingFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub correction: Vec<VideoObjectCorrectionFieldEnum>,
    ///<https://schema.org/author>
    #[serde(rename = "author")]
    #[serde_as(as = "OneOrMany<_>")]
    pub author: Vec<VideoObjectAuthorFieldEnum>,
    ///<https://schema.org/genre>
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<VideoObjectMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<VideoObjectIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<VideoObjectAdditionalTypeFieldEnum>,
