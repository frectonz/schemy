...
pub struct WebPageElement {
    ...
    pub acquire_license_page: Vec<WebPageElementAcquireLicensePageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub maintainer: Vec<WebPageElementMaintainerFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<WebPageElementFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub translator: Vec<WebPageElementTranslatorFieldEnum>,
    ///https://schema.org/assesses
    #[serde(rename = "assesses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub assesses: Vec<WebPageElementAssessesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<WebPageElementPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub learning_resource_type: Vec<WebPageElementLearningResourceTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub position: Vec<WebPageElementPositionFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub license: Vec<WebPageElementLicenseFieldEnum>,
    ///https://schema.org/fileFormat
    #[serde(rename = "fileFormat")]
    #[serde_as(as = "OneOrMany<_>")]
    pub file_format: Vec<WebPageElementFileFormatFieldEnum>,
    ///https://schema.org/producer
    #[serde(rename = "producer")]
    #[serde_as(as = "OneOrMany<_>")]
    pub producer: Vec<WebPageElementProducerFieldEnum>,
    ///https://schema.org/genre
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    pub genre: Vec<WebPageElementGenreFieldEnum>,
    ///https://schema.org/temporal
    #[serde(rename = "temporal")]
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal: Vec<WebPageElementTemporalFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub edit_eidr: Vec<WebPageElementEditEIDRFieldEnum>,
    ///https://schema.org/contentRating
    #[serde(rename = "contentRating")]
    #[serde_as(as = "OneOrMany<_>")]
    pub content_rating: Vec<WebPageElementContentRatingFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub citation: Vec<WebPageElementCitationFieldEnum>,
    ///https://schema.org/mainEntityOfPage
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<WebPageElementMainEntityOfPageFieldEnum>,
    ///https://schema.org/educationalUse
    #[serde(rename = "educationalUse")]
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_use: Vec<WebPageElementEducationalUseFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_part_of: Vec<WebPageElementIsPartOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<WebPageElementIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub version: Vec<WebPageElementVersionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material_extent: Vec<WebPageElementMaterialExtentFieldEnum>,
    ///https://schema.org/publisher
    #[serde(rename = "publisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publisher: Vec<WebPageElementPublisherFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub encoding_format: Vec<WebPageElementEncodingFormatFieldEnum>,
    ///https://schema.org/video
    #[serde(rename = "video")]
    #[serde_as(as = "OneOrMany<_>")]
    pub video: Vec<WebPageElementVideoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub copyright_holder: Vec<WebPageElementCopyrightHolderFieldEnum>,
    ///https://schema.org/provider
    #[serde(rename = "provider")]
    #[serde_as(as = "OneOrMany<_>")]
    pub provider: Vec<WebPageElementProviderFieldEnum>,
    ///https://schema.org/datePublished
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub creative_work_status: Vec<WebPageElementCreativeWorkStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub pattern: Vec<WebPageElementPatternFieldEnum>,
    ///https://schema.org/text
    #[serde(rename = "text")]
    #[serde_as(as = "OneOrMany<_>")]
    pub text: Vec<String>,
    ...
    #[serde(rename = "audio")]
    #[serde_as(as = "OneOrMany<_>")]
    pub audio: Vec<WebPageElementAudioFieldEnum>,
    ///https://schema.org/dateCreated
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub contributor: Vec<WebPageElementContributorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal_coverage: Vec<WebPageElementTemporalCoverageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub schema_version: Vec<WebPageElementSchemaVersionFieldEnum>,
    ///https://schema.org/creator
    #[serde(rename = "creator")]
    #[serde_as(as = "OneOrMany<_>")]
    pub creator: Vec<WebPageElementCreatorFieldEnum>,
    ...
    #[serde(rename = "offers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub offers: Vec<WebPageElementOffersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub expires: Vec<WebPageElementExpiresFieldEnum>,
    ///https://schema.org/sdLicense
    #[serde(rename = "sdLicense")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_license: Vec<WebPageElementSdLicenseFieldEnum>,
    ///https://schema.org/size
    #[serde(rename = "size")]
    #[serde_as(as = "OneOrMany<_>")]
    pub size: Vec<WebPageElementSizeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<WebPageElementAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<WebPageElementSponsorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_level: Vec<WebPageElementEducationalLevelFieldEnum>,
    ///https://schema.org/material
    #[serde(rename = "material")]
    #[serde_as(as = "OneOrMany<_>")]
    pub material: Vec<WebPageElementMaterialFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub teaches: Vec<WebPageElementTeachesFieldEnum>,
    ///https://schema.org/usageInfo
    #[serde(rename = "usageInfo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub usage_info: Vec<WebPageElementUsageInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub correction: Vec<WebPageElementCorrectionFieldEnum>,
}
