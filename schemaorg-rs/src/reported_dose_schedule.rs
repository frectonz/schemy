...
pub type ReportedDoseScheduleAdditionalTypeFieldEnum = String;
...
pub struct ReportedDoseSchedule {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub dose_value: Vec<ReportedDoseScheduleDoseValueFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<ReportedDoseScheduleIdentifierFieldEnum>,
    ///https://schema.org/description
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<ReportedDoseScheduleDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<ReportedDoseScheduleLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<ReportedDoseScheduleMainEntityOfPageFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<ReportedDoseScheduleSubjectOfFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<ReportedDoseScheduleImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<ReportedDoseScheduleAdditionalTypeFieldEnum>,
}
