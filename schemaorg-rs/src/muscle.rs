...
pub type MuscleAdditionalTypeFieldEnum = String;
...
pub struct Muscle {
    ...
    pub antagonist: Vec<Muscle>,
    ///<https://schema.org/nerve>
    #[serde(rename = "nerve")]
    #[serde_as(as = "OneOrMany<_>")]
    pub nerve: Vec<Nerve>,
    ///<https://schema.org/bloodSupply>
    #[serde(rename = "bloodSupply")]
    #[serde_as(as = "OneOrMany<_>")]
    pub blood_supply: Vec<Vessel>,
    ///<https://schema.org/muscleAction>
    #[serde(rename = "muscleAction")]
    #[serde_as(as = "OneOrMany<_>")]
    pub muscle_action: Vec<String>,
    ///<https://schema.org/insertion>
    #[serde(rename = "insertion")]
    #[serde_as(as = "OneOrMany<_>")]
    pub insertion: Vec<AnatomicalStructure>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<MuscleLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<MuscleMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<MuscleIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<MuscleDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<MuscleSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<MuscleAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<MuscleImageFieldEnum>,
}
