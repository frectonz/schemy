...
pub type FMRadioChannelAdditionalTypeFieldEnum = String;
///<https://schema.org/genre>
///<https://schema.org/Text>
///<https://schema.org/URL>
pub type FMRadioChannelGenreFieldEnum = String;
...
pub struct FMRadioChannel {
    ...
    pub main_entity_of_page: Vec<FMRadioChannelMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<FMRadioChannelDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<FMRadioChannelSubjectOfFieldEnum>,
    ///<https://schema.org/additionalType>
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<FMRadioChannelAdditionalTypeFieldEnum>,
    ///<https://schema.org/image>
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<FMRadioChannelImageFieldEnum>,
    ...
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    pub genre: Vec<FMRadioChannelGenreFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub broadcast_frequency: Vec<FMRadioChannelBroadcastFrequencyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<FMRadioChannelIdentifierFieldEnum>,
}
