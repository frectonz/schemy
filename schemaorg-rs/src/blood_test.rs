...
pub type BloodTestAdditionalTypeFieldEnum = String;
...
pub struct BloodTest {
    ...
    pub identifier: Vec<BloodTestIdentifierFieldEnum>,
    ///https://schema.org/description
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<BloodTestDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<BloodTestMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<BloodTestSubjectOfFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<BloodTestImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<BloodTestLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<BloodTestAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub normal_range: Vec<BloodTestNormalRangeFieldEnum>,
}
