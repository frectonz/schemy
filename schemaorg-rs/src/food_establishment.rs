...
pub type FoodEstablishmentAdditionalTypeFieldEnum = String;
///https://schema.org/acceptsReservations
///https://schema.org/Boolean
///https://schema.org/Text
///https://schema.org/URL
pub type FoodEstablishmentAcceptsReservationsFieldEnum = String;
...
pub struct FoodEstablishment {
    ...
    pub ethics_policy: Vec<FoodEstablishmentEthicsPolicyFieldEnum>,
    ...
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<FoodEstablishmentGeoFieldEnum>,
    ...
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<FoodEstablishmentPhotosFieldEnum>,
    ///https://schema.org/geoCovers
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<FoodEstablishmentGeoCoversFieldEnum>,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<FoodEstablishmentLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<FoodEstablishmentLocationFieldEnum>,
    ///https://schema.org/knowsAbout
    #[serde(rename = "knowsAbout")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<FoodEstablishmentKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<FoodEstablishmentKeywordsFieldEnum>,
    ///https://schema.org/address
    #[serde(rename = "address")]
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<FoodEstablishmentAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<FoodEstablishmentGeoEqualsFieldEnum>,
    ///https://schema.org/brand
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<FoodEstablishmentBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<FoodEstablishmentMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<FoodEstablishmentAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<FoodEstablishmentGeoIntersectsFieldEnum>,
    ///https://schema.org/funder
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<FoodEstablishmentFunderFieldEnum>,
    ///https://schema.org/geoWithin
    #[serde(rename = "geoWithin")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<FoodEstablishmentGeoWithinFieldEnum>,
    ///https://schema.org/skills
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<FoodEstablishmentSkillsFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<FoodEstablishmentPhotoFieldEnum>,
    ///https://schema.org/acceptsReservations
    #[serde(rename = "acceptsReservations")]
    #[serde_as(as = "OneOrMany<_>")]
    pub accepts_reservations: Vec<FoodEstablishmentAcceptsReservationsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<FoodEstablishmentDiversityPolicyFieldEnum>,
    ///https://schema.org/identifier
    #[serde(rename = "identifier")]
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<FoodEstablishmentIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<FoodEstablishmentPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<FoodEstablishmentMainEntityOfPageFieldEnum>,
    ///https://schema.org/longitude
    #[serde(rename = "longitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<FoodEstablishmentLongitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<FoodEstablishmentOwnershipFundingInfoFieldEnum>,
    ///https://schema.org/areaServed
    #[serde(rename = "areaServed")]
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<FoodEstablishmentAreaServedFieldEnum>,
    ///https://schema.org/owns
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<FoodEstablishmentOwnsFieldEnum>,
    ///https://schema.org/knowsLanguage
    #[serde(rename = "knowsLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<FoodEstablishmentKnowsLanguageFieldEnum>,
    ///https://schema.org/serviceArea
    #[serde(rename = "serviceArea")]
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<FoodEstablishmentServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<FoodEstablishmentGeoCoveredByFieldEnum>,
    ///https://schema.org/members
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<FoodEstablishmentMembersFieldEnum>,
    ///https://schema.org/diversityStaffingReport
    #[serde(rename = "diversityStaffingReport")]
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<
        FoodEstablishmentDiversityStaffingReportFieldEnum,
    >,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<FoodEstablishmentLatitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<FoodEstablishmentUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<FoodEstablishmentCorrectionsPolicyFieldEnum>,
    ///https://schema.org/hasMap
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<FoodEstablishmentHasMapFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<FoodEstablishmentAcceptedPaymentMethodFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<FoodEstablishmentGeoTouchesFieldEnum>,
    ...
    #[serde(rename = "menu")]
    #[serde_as(as = "OneOrMany<_>")]
    pub menu: Vec<FoodEstablishmentMenuFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<FoodEstablishmentImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<FoodEstablishmentDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<FoodEstablishmentGeoCrossesFieldEnum>,
    ...
    pub actionable_feedback_policy: Vec<
        FoodEstablishmentActionableFeedbackPolicyFieldEnum,
    >,
    ///https://schema.org/sponsor
    #[serde(rename = "sponsor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<FoodEstablishmentSponsorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<FoodEstablishmentGeoOverlapsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub has_menu: Vec<FoodEstablishmentHasMenuFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<FoodEstablishmentFounderFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<FoodEstablishmentMemberFieldEnum>,
    ///https://schema.org/geoContains
    #[serde(rename = "geoContains")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<FoodEstablishmentGeoContainsFieldEnum>,
    ///https://schema.org/geoDisjoint
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<FoodEstablishmentGeoDisjointFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<FoodEstablishmentSubjectOfFieldEnum>,
