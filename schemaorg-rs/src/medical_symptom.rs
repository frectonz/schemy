...
pub type MedicalSymptomAdditionalTypeFieldEnum = String;
...
pub struct MedicalSymptom {
    ...
    pub subject_of: Vec<MedicalSymptomSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<MedicalSymptomAdditionalTypeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<MedicalSymptomDescriptionFieldEnum>,
    ...
    #[serde(rename = "status")]
    #[serde_as(as = "OneOrMany<_>")]
    pub status: Vec<MedicalSymptomStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<MedicalSymptomLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<MedicalSymptomIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<MedicalSymptomMainEntityOfPageFieldEnum>,
    ///<https://schema.org/image>
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<MedicalSymptomImageFieldEnum>,
    ///<https://schema.org/associatedAnatomy>
    #[serde(rename = "associatedAnatomy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub associated_anatomy: Vec<MedicalSymptomAssociatedAnatomyFieldEnum>,
}
