...
pub type MovieTheaterAdditionalTypeFieldEnum = String;
...
pub struct MovieTheater {
    ...
    pub description: Vec<MovieTheaterDescriptionFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<MovieTheaterImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<MovieTheaterSubjectOfFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<MovieTheaterFunderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<MovieTheaterGeoEqualsFieldEnum>,
    ///<https://schema.org/geoOverlaps>
    #[serde(rename = "geoOverlaps")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<MovieTheaterGeoOverlapsFieldEnum>,
    ///<https://schema.org/serviceArea>
    #[serde(rename = "serviceArea")]
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<MovieTheaterServiceAreaFieldEnum>,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<MovieTheaterLogoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<MovieTheaterGeoIntersectsFieldEnum>,
    ///<https://schema.org/keywords>
    #[serde(rename = "keywords")]
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<MovieTheaterKeywordsFieldEnum>,
    ///<https://schema.org/geoCrosses>
    #[serde(rename = "geoCrosses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<MovieTheaterGeoCrossesFieldEnum>,
    ///<https://schema.org/latitude>
    #[serde(rename = "latitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<MovieTheaterLatitudeFieldEnum>,
    ///<https://schema.org/brand>
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<MovieTheaterBrandFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<MovieTheaterCorrectionsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<MovieTheaterActionableFeedbackPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<MovieTheaterIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<MovieTheaterSponsorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<MovieTheaterLocationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<MovieTheaterUnnamedSourcesPolicyFieldEnum>,
    ///<https://schema.org/photo>
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<MovieTheaterPhotoFieldEnum>,
    ///<https://schema.org/geoCoveredBy>
    #[serde(rename = "geoCoveredBy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<MovieTheaterGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<MovieTheaterAdditionalTypeFieldEnum>,
    ///<https://schema.org/screenCount>
    #[serde(rename = "screenCount")]
    #[serde_as(as = "OneOrMany<_>")]
    pub screen_count: Vec<f32>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<MovieTheaterKnowsLanguageFieldEnum>,
    ...
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<MovieTheaterMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<MovieTheaterAcceptedPaymentMethodFieldEnum>,
    ///<https://schema.org/founder>
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<MovieTheaterFounderFieldEnum>,
    ///<https://schema.org/longitude>
    #[serde(rename = "longitude")]
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<MovieTheaterLongitudeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<MovieTheaterAreaServedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<MovieTheaterKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<MovieTheaterAddressFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<MovieTheaterSkillsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<MovieTheaterGeoWithinFieldEnum>,
    ///<https://schema.org/mainEntityOfPage>
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<MovieTheaterMainEntityOfPageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<MovieTheaterPublishingPrinciplesFieldEnum>,
    ///<https://schema.org/ethicsPolicy>
    #[serde(rename = "ethicsPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<MovieTheaterEthicsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<MovieTheaterGeoCoversFieldEnum>,
    ///<https://schema.org/owns>
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<MovieTheaterOwnsFieldEnum>,
    ///<https://schema.org/members>
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<MovieTheaterMembersFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<MovieTheaterGeoDisjointFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<MovieTheaterDiversityStaffingReportFieldEnum>,
    ...
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<MovieTheaterPhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<MovieTheaterOwnershipFundingInfoFieldEnum>,
    ///<https://schema.org/geoContains>
    #[serde(rename = "geoContains")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<MovieTheaterGeoContainsFieldEnum>,
    ///<https://schema.org/geoTouches>
    #[serde(rename = "geoTouches")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<MovieTheaterGeoTouchesFieldEnum>,
    ///<https://schema.org/memberOf>
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<MovieTheaterMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<MovieTheaterDiversityPolicyFieldEnum>,
    ...
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<MovieTheaterGeoFieldEnum>,
    ///<https://schema.org/hasMap>
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<MovieTheaterHasMapFieldEnum>,
}
