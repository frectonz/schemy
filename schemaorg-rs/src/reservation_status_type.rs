...
pub type ReservationStatusTypeAdditionalTypeFieldEnum = String;
...
pub struct ReservationStatusType {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<ReservationStatusTypeIdentifierFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<ReservationStatusTypeImageFieldEnum>,
}
