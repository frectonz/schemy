...
pub type DrugPrescriptionStatusAdditionalTypeFieldEnum = String;
...
pub struct DrugPrescriptionStatus {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub main_entity_of_page: Vec<DrugPrescriptionStatusMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub description: Vec<DrugPrescriptionStatusDescriptionFieldEnum>,
