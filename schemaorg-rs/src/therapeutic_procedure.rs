...
pub type TherapeuticProcedureAdditionalTypeFieldEnum = String;
...
pub struct TherapeuticProcedure {
    ...
    pub description: Vec<TherapeuticProcedureDescriptionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<TherapeuticProcedureLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<TherapeuticProcedureMainEntityOfPageFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<TherapeuticProcedureSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<TherapeuticProcedureIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub preparation: Vec<TherapeuticProcedurePreparationFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<TherapeuticProcedureImageFieldEnum>,
    ///<https://schema.org/status>
    #[serde(rename = "status")]
    #[serde_as(as = "OneOrMany<_>")]
    pub status: Vec<TherapeuticProcedureStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<TherapeuticProcedureAdditionalTypeFieldEnum>,
}
