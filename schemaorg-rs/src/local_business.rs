...
pub type LocalBusinessAdditionalTypeFieldEnum = String;
...
pub struct LocalBusiness {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub unnamed_sources_policy: Vec<LocalBusinessUnnamedSourcesPolicyFieldEnum>,
    ...
    #[serde(rename = "skills")]
    #[serde_as(as = "OneOrMany<_>")]
    pub skills: Vec<LocalBusinessSkillsFieldEnum>,
    ///<https://schema.org/publishingPrinciples>
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<LocalBusinessPublishingPrinciplesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_about: Vec<LocalBusinessKnowsAboutFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ownership_funding_info: Vec<LocalBusinessOwnershipFundingInfoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub service_area: Vec<LocalBusinessServiceAreaFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<LocalBusinessKeywordsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub location: Vec<LocalBusinessLocationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_policy: Vec<LocalBusinessDiversityPolicyFieldEnum>,
    ...
    #[serde(rename = "logo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub logo: Vec<LocalBusinessLogoFieldEnum>,
    ...
    #[serde(rename = "owns")]
    #[serde_as(as = "OneOrMany<_>")]
    pub owns: Vec<LocalBusinessOwnsFieldEnum>,
    ...
    #[serde(rename = "brand")]
    #[serde_as(as = "OneOrMany<_>")]
    pub brand: Vec<LocalBusinessBrandFieldEnum>,
    ///<https://schema.org/knowsLanguage>
    #[serde(rename = "knowsLanguage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub knows_language: Vec<LocalBusinessKnowsLanguageFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<LocalBusinessFunderFieldEnum>,
    ///<https://schema.org/address>
    #[serde(rename = "address")]
    #[serde_as(as = "OneOrMany<_>")]
    pub address: Vec<LocalBusinessAddressFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub corrections_policy: Vec<LocalBusinessCorrectionsPolicyFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<LocalBusinessSponsorFieldEnum>,
    ///<https://schema.org/memberOf>
    #[serde(rename = "memberOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member_of: Vec<LocalBusinessMemberOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub diversity_staffing_report: Vec<LocalBusinessDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub ethics_policy: Vec<LocalBusinessEthicsPolicyFieldEnum>,
    ///<https://schema.org/actionableFeedbackPolicy>
    #[serde(rename = "actionableFeedbackPolicy")]
    #[serde_as(as = "OneOrMany<_>")]
    pub actionable_feedback_policy: Vec<LocalBusinessActionableFeedbackPolicyFieldEnum>,
    ///<https://schema.org/areaServed>
    #[serde(rename = "areaServed")]
    #[serde_as(as = "OneOrMany<_>")]
    pub area_served: Vec<LocalBusinessAreaServedFieldEnum>,
    ///<https://schema.org/members>
    #[serde(rename = "members")]
    #[serde_as(as = "OneOrMany<_>")]
    pub members: Vec<LocalBusinessMembersFieldEnum>,
    ///<https://schema.org/member>
    #[serde(rename = "member")]
    #[serde_as(as = "OneOrMany<_>")]
    pub member: Vec<LocalBusinessMemberFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub accepted_payment_method: Vec<LocalBusinessAcceptedPaymentMethodFieldEnum>,
    ///<https://schema.org/founder>
    #[serde(rename = "founder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub founder: Vec<LocalBusinessFounderFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<LocalBusinessMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<LocalBusinessIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<LocalBusinessDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<LocalBusinessSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<LocalBusinessAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<LocalBusinessImageFieldEnum>,
    ///<https://schema.org/photos>
    #[serde(rename = "photos")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photos: Vec<LocalBusinessPhotosFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_intersects: Vec<LocalBusinessGeoIntersectsFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_overlaps: Vec<LocalBusinessGeoOverlapsFieldEnum>,
    ///<https://schema.org/geoCrosses>
    #[serde(rename = "geoCrosses")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_crosses: Vec<LocalBusinessGeoCrossesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covered_by: Vec<LocalBusinessGeoCoveredByFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_contains: Vec<LocalBusinessGeoContainsFieldEnum>,
    ///<https://schema.org/geo>
    #[serde(rename = "geo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo: Vec<LocalBusinessGeoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub latitude: Vec<LocalBusinessLatitudeFieldEnum>,
    ...
    #[serde(rename = "hasMap")]
    #[serde_as(as = "OneOrMany<_>")]
    pub has_map: Vec<LocalBusinessHasMapFieldEnum>,
    ///<https://schema.org/geoTouches>
    #[serde(rename = "geoTouches")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_touches: Vec<LocalBusinessGeoTouchesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_within: Vec<LocalBusinessGeoWithinFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub longitude: Vec<LocalBusinessLongitudeFieldEnum>,
    ///<https://schema.org/geoDisjoint>
    #[serde(rename = "geoDisjoint")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_disjoint: Vec<LocalBusinessGeoDisjointFieldEnum>,
    ///<https://schema.org/geoCovers>
    #[serde(rename = "geoCovers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_covers: Vec<LocalBusinessGeoCoversFieldEnum>,
    ...
    #[serde(rename = "photo")]
    #[serde_as(as = "OneOrMany<_>")]
    pub photo: Vec<LocalBusinessPhotoFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub geo_equals: Vec<LocalBusinessGeoEqualsFieldEnum>,
}
