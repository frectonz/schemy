...
pub type TrainReservationAdditionalTypeFieldEnum = String;
...
pub struct TrainReservation {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub booking_agent: Vec<TrainReservationBookingAgentFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub identifier: Vec<TrainReservationIdentifierFieldEnum>,
