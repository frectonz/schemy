...
pub type RadiationTherapyAdditionalTypeFieldEnum = String;
...
pub struct RadiationTherapy {
    ...
    pub contraindication: Vec<RadiationTherapyContraindicationFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub preparation: Vec<RadiationTherapyPreparationFieldEnum>,
    ///<https://schema.org/status>
    #[serde(rename = "status")]
    #[serde_as(as = "OneOrMany<_>")]
    pub status: Vec<RadiationTherapyStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub legal_status: Vec<RadiationTherapyLegalStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<RadiationTherapyMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<RadiationTherapyIdentifierFieldEnum>,
    ///<https://schema.org/description>
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<RadiationTherapyDescriptionFieldEnum>,
    ///<https://schema.org/subjectOf>
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<RadiationTherapySubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<RadiationTherapyAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<RadiationTherapyImageFieldEnum>,
}
