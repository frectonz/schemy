...
pub type CommentTemporalFieldEnum = String;
...
///https://schema.org/Text
///https://schema.org/URL
pub type CommentEncodingFormatFieldEnum = String;
///https://schema.org/editEIDR
///https://schema.org/Text
///https://schema.org/URL
pub type CommentEditEIDRFieldEnum = String;
///https://schema.org/temporalCoverage
///https://schema.org/DateTime
///https://schema.org/Text
///https://schema.org/URL
pub type CommentTemporalCoverageFieldEnum = String;
///https://schema.org/genre
///https://schema.org/Text
///https://schema.org/URL
pub type CommentGenreFieldEnum = String;
...
///https://schema.org/Text
///https://schema.org/URL
pub type CommentSchemaVersionFieldEnum = String;
///https://schema.org/fileFormat
///https://schema.org/Text
///https://schema.org/URL
pub type CommentFileFormatFieldEnum = String;
...
///https://schema.org/Date
///https://schema.org/DateTime
pub type CommentExpiresFieldEnum = String;
...
pub struct Comment {
    ...
    pub in_language: Vec<CommentInLanguageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub copyright_holder: Vec<CommentCopyrightHolderFieldEnum>,
    ///https://schema.org/author
    #[serde(rename = "author")]
    #[serde_as(as = "OneOrMany<_>")]
    pub author: Vec<CommentAuthorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on: Vec<CommentIsBasedOnFieldEnum>,
    ///https://schema.org/position
    #[serde(rename = "position")]
    #[serde_as(as = "OneOrMany<_>")]
    pub position: Vec<CommentPositionFieldEnum>,
    ///https://schema.org/url
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    pub url: Vec<String>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub usage_info: Vec<CommentUsageInfoFieldEnum>,
    ///https://schema.org/citation
    #[serde(rename = "citation")]
    #[serde_as(as = "OneOrMany<_>")]
    pub citation: Vec<CommentCitationFieldEnum>,
    ///https://schema.org/size
    #[serde(rename = "size")]
    #[serde_as(as = "OneOrMany<_>")]
    pub size: Vec<CommentSizeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal: Vec<CommentTemporalFieldEnum>,
    ///https://schema.org/maintainer
    #[serde(rename = "maintainer")]
    #[serde_as(as = "OneOrMany<_>")]
    pub maintainer: Vec<CommentMaintainerFieldEnum>,
    ...
    #[serde(rename = "funder")]
    #[serde_as(as = "OneOrMany<_>")]
    pub funder: Vec<CommentFunderFieldEnum>,
    ///https://schema.org/additionalType
    #[serde(rename = "additionalType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub additional_type: Vec<CommentAdditionalTypeFieldEnum>,
    ...
    #[serde(rename = "audio")]
    #[serde_as(as = "OneOrMany<_>")]
    pub audio: Vec<CommentAudioFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub encoding_format: Vec<CommentEncodingFormatFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub license: Vec<CommentLicenseFieldEnum>,
    ///https://schema.org/publishingPrinciples
    #[serde(rename = "publishingPrinciples")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publishing_principles: Vec<CommentPublishingPrinciplesFieldEnum>,
    ...
    #[serde(rename = "offers")]
    #[serde_as(as = "OneOrMany<_>")]
    pub offers: Vec<CommentOffersFieldEnum>,
    ///https://schema.org/educationalLevel
    #[serde(rename = "educationalLevel")]
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_level: Vec<CommentEducationalLevelFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub creator: Vec<CommentCreatorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub edit_eidr: Vec<CommentEditEIDRFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub teaches: Vec<CommentTeachesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub is_based_on_url: Vec<CommentIsBasedOnUrlFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub correction: Vec<CommentCorrectionFieldEnum>,
    ///https://schema.org/description
    #[serde(rename = "description")]
    #[serde_as(as = "OneOrMany<_>")]
    pub description: Vec<CommentDescriptionFieldEnum>,
    ///https://schema.org/mainEntityOfPage
    #[serde(rename = "mainEntityOfPage")]
    #[serde_as(as = "OneOrMany<_>")]
    pub main_entity_of_page: Vec<CommentMainEntityOfPageFieldEnum>,
    ///https://schema.org/subjectOf
    #[serde(rename = "subjectOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub subject_of: Vec<CommentSubjectOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub assesses: Vec<CommentAssessesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub temporal_coverage: Vec<CommentTemporalCoverageFieldEnum>,
    ///https://schema.org/contentRating
    #[serde(rename = "contentRating")]
    #[serde_as(as = "OneOrMany<_>")]
    pub content_rating: Vec<CommentContentRatingFieldEnum>,
    ...
    #[serde(rename = "genre")]
    #[serde_as(as = "OneOrMany<_>")]
    pub genre: Vec<CommentGenreFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub keywords: Vec<CommentKeywordsFieldEnum>,
    ///https://schema.org/creativeWorkStatus
    #[serde(rename = "creativeWorkStatus")]
    #[serde_as(as = "OneOrMany<_>")]
    pub creative_work_status: Vec<CommentCreativeWorkStatusFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_published: Vec<CommentDatePublishedFieldEnum>,
    ///https://schema.org/image
    #[serde(rename = "image")]
    #[serde_as(as = "OneOrMany<_>")]
    pub image: Vec<CommentImageFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub translator: Vec<CommentTranslatorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub producer: Vec<CommentProducerFieldEnum>,
    ///https://schema.org/sdPublisher
    #[serde(rename = "sdPublisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_publisher: Vec<CommentSdPublisherFieldEnum>,
    ///https://schema.org/schemaVersion
    #[serde(rename = "schemaVersion")]
    #[serde_as(as = "OneOrMany<_>")]
    pub schema_version: Vec<CommentSchemaVersionFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub acquire_license_page: Vec<CommentAcquireLicensePageFieldEnum>,
    ///https://schema.org/learningResourceType
    #[serde(rename = "learningResourceType")]
    #[serde_as(as = "OneOrMany<_>")]
    pub learning_resource_type: Vec<CommentLearningResourceTypeFieldEnum>,
    ///https://schema.org/parentItem
    #[serde(rename = "parentItem")]
    #[serde_as(as = "OneOrMany<_>")]
    pub parent_item: Vec<CommentParentItemFieldEnum>,
    ///https://schema.org/contributor
    #[serde(rename = "contributor")]
    #[serde_as(as = "OneOrMany<_>")]
    pub contributor: Vec<CommentContributorFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material_extent: Vec<CommentMaterialExtentFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub educational_use: Vec<CommentEducationalUseFieldEnum>,
    ...
    #[serde(rename = "video")]
    #[serde_as(as = "OneOrMany<_>")]
    pub video: Vec<CommentVideoFieldEnum>,
    ///https://schema.org/archivedAt
    #[serde(rename = "archivedAt")]
    #[serde_as(as = "OneOrMany<_>")]
    pub archived_at: Vec<CommentArchivedAtFieldEnum>,
    ///https://schema.org/fileFormat
    #[serde(rename = "fileFormat")]
    #[serde_as(as = "OneOrMany<_>")]
    pub file_format: Vec<CommentFileFormatFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub material: Vec<CommentMaterialFieldEnum>,
    ///https://schema.org/dateCreated
    #[serde(rename = "dateCreated")]
    #[serde_as(as = "OneOrMany<_>")]
    pub date_created: Vec<CommentDateCreatedFieldEnum>,
    ///https://schema.org/provider
    #[serde(rename = "provider")]
    #[serde_as(as = "OneOrMany<_>")]
    pub provider: Vec<CommentProviderFieldEnum>,
    ///https://schema.org/identifier
    #[serde(rename = "identifier")]
    #[serde_as(as = "OneOrMany<_>")]
    pub identifier: Vec<CommentIdentifierFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub date_modified: Vec<CommentDateModifiedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sd_license: Vec<CommentSdLicenseFieldEnum>,
    ///https://schema.org/expires
    #[serde(rename = "expires")]
    #[serde_as(as = "OneOrMany<_>")]
    pub expires: Vec<CommentExpiresFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub sponsor: Vec<CommentSponsorFieldEnum>,
    ///https://schema.org/version
    #[serde(rename = "version")]
    #[serde_as(as = "OneOrMany<_>")]
    pub version: Vec<CommentVersionFieldEnum>,
    ///https://schema.org/isPartOf
    #[serde(rename = "isPartOf")]
    #[serde_as(as = "OneOrMany<_>")]
    pub is_part_of: Vec<CommentIsPartOfFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    pub pattern: Vec<CommentPatternFieldEnum>,
    ///https://schema.org/publisher
    #[serde(rename = "publisher")]
    #[serde_as(as = "OneOrMany<_>")]
    pub publisher: Vec<CommentPublisherFieldEnum>,
}
